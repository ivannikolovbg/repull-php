...
/**
 * UpdateAirbnbMessageRequest Class Doc Comment
 *
 * @package  Repull
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class UpdateAirbnbMessageRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'update_airbnb_message_request';
    ...
    public const ACTION_UNSEND = 'unsend';
     ...
     * Sets action
     *
     * @param string $action Operation to perform on the message.
     *
     * @return $this
     */
     ...
     * Sets message
     *
     * @param string|null $message New message text. Required when `action` is `edit`.
     *
     * @return $this
     */
     ...
     * Sets reaction
     *
     * @param string|null $reaction Reaction to add. Required when `action` is `react`.
     *
     * @return $this
     */
