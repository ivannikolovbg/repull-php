...
/**
 * StudioGeneration Class Doc Comment
 *
 ...
 */
class StudioGeneration implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'StudioGeneration';
     ...
     * Sets response
     *
     * @param string|null $response Generated text output.
     *
     * @return $this
     */
     ...
     * Sets tokens_in
     *
     * @param int|null $tokens_in Prompt tokens consumed.
     *
     * @return $this
     */
     ...
     * Sets tokens_out
     *
     * @param int|null $tokens_out Completion tokens produced.
     *
     * @return $this
     */
     ...
     * Sets model
     *
     * @param string|null $model Model identifier used to produce the response.
     *
     * @return $this
     */
