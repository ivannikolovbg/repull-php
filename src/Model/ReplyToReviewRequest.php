...
/**
 * ReplyToReviewRequest Class Doc Comment
 *
 * @package  Repull
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ReplyToReviewRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'replyToReview_request';
     ...
     * Sets message
     *
     * @param string $message Reply text. `response` is accepted as an alias.
     *
     * @return $this
     */
