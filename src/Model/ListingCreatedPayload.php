...
/**
 * ListingCreatedPayload Class Doc Comment
 *
 ...
 */
class ListingCreatedPayload implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'ListingCreatedPayload';
    ...
    protected static array $openAPITypes = [
        'id' => 'int',
        'title' => 'string',
        'address' => '\Repull\Model\ListingCreatedPayloadAddress',
        'bedrooms' => 'int',
        'bathrooms' => 'float',
        'max_guests' => 'int',
        'created_at' => '\DateTime'
     ...
     * Gets address
     *
     * @return \Repull\Model\ListingCreatedPayloadAddress|null
     */
    public function getAddress(): ?\Repull\Model\ListingCreatedPayloadAddress
    {
     ...
     * Sets address
     *
     * @param \Repull\Model\ListingCreatedPayloadAddress|null $address address
     *
     * @return $this
     */
    public function setAddress(?\Repull\Model\ListingCreatedPayloadAddress $address): static
    {
        if (is_null($address)) {
