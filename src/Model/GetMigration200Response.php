...
/**
 * GetMigration200Response Class Doc Comment
 *
 * @package  Repull
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class GetMigration200Response implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'getMigration_200_response';
     ...
     */
    public function getData(): ?\Repull\Model\Migration
    {
     ...
     * @return $this
     */
    public function setData(?\Repull\Model\Migration $data): static
    {
        if (is_null($data)) {
