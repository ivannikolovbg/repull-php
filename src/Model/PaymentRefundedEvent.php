...
/**
 * PaymentRefundedEvent Class Doc Comment
 *
 * @package  Repull
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class PaymentRefundedEvent implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'PaymentRefundedEvent';
    ...
    protected static array $openAPITypes = [
        ...
        'created_at' => '\DateTime',
        'api_version' => 'string',
        'data' => '\Repull\Model\PaymentRefundedPayload'
    ];
     ...
     * Gets data
     *
     * @return \Repull\Model\PaymentRefundedPayload
     */
    public function getData(): \Repull\Model\PaymentRefundedPayload
    {
     ...
     * Sets data
     *
     * @param \Repull\Model\PaymentRefundedPayload $data data
     *
     * @return $this
     */
    public function setData(\Repull\Model\PaymentRefundedPayload $data): static
    {
        if (is_null($data)) {
