...
/**
 * BookingSetupRequest Class Doc Comment
 *
 * @package  Repull
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class BookingSetupRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'booking_setup_request';
    ...
    public const ACTION_OPEN_PROPERTY = 'open-property';
    public const ACTION_SET_CONTACTS = 'set-contacts';
    public const ACTION_SET_POLICIES = 'set-policies';
    ...
    public static function getActionAllowableValues()
    {
        return [
            ...
            self::ACTION_OPEN_PROPERTY,
            self::ACTION_SET_CONTACTS,
            self::ACTION_SET_POLICIES,
        ];
    }
     ...
     * @return $this
     */
    public function setLeid(?int $leid): static
    {
        if (is_null($leid)) {
            throw new InvalidArgumentException('non-nullable leid cannot be null');
        }
        $this->container['leid'] = $leid;
     ...
     * Sets contacts
     *
     * @param array<string,mixed>[]|null $contacts Contacts payload for `set-contacts`.
     *
     * @return $this
     */
