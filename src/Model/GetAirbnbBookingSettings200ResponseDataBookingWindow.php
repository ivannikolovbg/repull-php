<?php
/**
 * GetAirbnbBookingSettings200ResponseDataBookingWindow
 *
 * PHP version 8.1
 *
 * @package  Repull
...
/**
 * GetAirbnbBookingSettings200ResponseDataBookingWindow Class Doc Comment
 *
 ...
 */
class GetAirbnbBookingSettings200ResponseDataBookingWindow implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'get_airbnb_booking_settings_200_response_data_bookingWindow';
     ...
     * Sets days
     *
     * @param int|null $days `null` when unlimited.
     *
     * @return $this
     */
