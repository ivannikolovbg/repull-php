...
/**
 * MapConnectBookingRoomsResponse Class Doc Comment
 *
 * @package  Repull
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class MapConnectBookingRoomsResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'MapConnectBookingRoomsResponse';
    ...
    public function listInvalidProperties(): array
    {
        ...
        if ($this->container['mapped'] === null) {
            $invalidProperties[] = "'mapped' can't be null";
        }
    ...
    {
        return $this->container['mapped'];
    }

    /**
     * Sets mapped
     *
     * @param int $mapped Number of rooms processed (mapped + unmapped).
     *
     * @return $this
     */
    public function setMapped(int $mapped): static
    {
        if (is_null($mapped)) {
            throw new InvalidArgumentException('non-nullable mapped cannot be null');
        }
        $this->container['mapped'] = $mapped;
