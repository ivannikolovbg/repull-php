...
/**
 * BookingPricingUpdateRequest Class Doc Comment
 *
 ...
 */
class BookingPricingUpdateRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'BookingPricingUpdateRequest';
    ...
    protected static array $openAPITypes = [
        'updates' => '\Repull\Model\BookingPricingRateUpdate[]'
    ];
     ...
     * Gets updates
     *
     * @return \Repull\Model\BookingPricingRateUpdate[]
     */
     ...
     * Sets updates
     *
     * @param \Repull\Model\BookingPricingRateUpdate[] $updates updates
     *
     * @return $this
     */
    public function setUpdates(array $updates): static
    {
        ...
        if ((count($updates) < 1)) {
            throw new InvalidArgumentException('invalid length for $updates when calling BookingPricingUpdateRequest., number of items must be greater than or equal to 1.');
        }
