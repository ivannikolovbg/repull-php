...
/**
 * ReviewCreatedEvent Class Doc Comment
 *
 * @package  Repull
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ReviewCreatedEvent implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'ReviewCreatedEvent';
    ...
    protected static array $openAPITypes = [
        ...
        'created_at' => '\DateTime',
        'api_version' => 'string',
        'data' => '\Repull\Model\ReviewCreatedPayload'
    ];
     ...
     * Gets data
     *
     * @return \Repull\Model\ReviewCreatedPayload
     */
    public function getData(): \Repull\Model\ReviewCreatedPayload
    {
     ...
     * Sets data
     *
     * @param \Repull\Model\ReviewCreatedPayload $data data
     *
     * @return $this
     */
    public function setData(\Repull\Model\ReviewCreatedPayload $data): static
    {
        if (is_null($data)) {
