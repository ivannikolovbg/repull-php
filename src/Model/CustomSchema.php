...
/**
 * CustomSchema Class Doc Comment
 *
 ...
 */
class CustomSchema implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'CustomSchema';
     ...
     * Sets id
     *
     * @param string $id Stable workspace-scoped identifier.
     *
     * @return $this
     */
     ...
     * Sets name
     *
     * @param string $name 3-100 lowercase chars, hyphens allowed (`^[a-z0-9][a-z0-9-]{1,98}[a-z0-9]$`). Must be unique within the workspace. Cannot collide with reserved names (`calry`, `calry-v1`, `native`).
     *
     * @return $this
     */
    ...
    public function setMappings(array $mappings): static
    {
        ...
        if ((count($mappings) > 50)) {
            throw new InvalidArgumentException('invalid value for $mappings when calling CustomSchema., number of items must be less than or equal to 50.');
        }
        if ((count($mappings) < 1)) {
            throw new InvalidArgumentException('invalid length for $mappings when calling CustomSchema., number of items must be greater than or equal to 1.');
        }
     ...
     * Sets active
     *
     * @param bool $active When `false`, requests carrying this schema name in `X-Schema` fall back to `native`.
     *
     * @return $this
     */
