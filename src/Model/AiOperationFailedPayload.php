...
/**
 * AiOperationFailedPayload Class Doc Comment
 *
 ...
 */
class AiOperationFailedPayload implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'AiOperationFailedPayload';
    ...
    protected static array $openAPITypes = [
        'operation_id' => 'string',
        'type' => 'string',
        'error' => '\Repull\Model\AiOperationFailedPayloadError',
        'failed_at' => '\DateTime'
    ];
     ...
     * Gets error
     *
     * @return \Repull\Model\AiOperationFailedPayloadError|null
     */
    public function getError(): ?\Repull\Model\AiOperationFailedPayloadError
    {
     ...
     * Sets error
     *
     * @param \Repull\Model\AiOperationFailedPayloadError|null $error error
     *
     * @return $this
     */
    public function setError(?\Repull\Model\AiOperationFailedPayloadError $error): static
    {
        if (is_null($error)) {
     ...
     * @return $this
     */
    public function setFailedAt(?\DateTime $failed_at): static
    {
