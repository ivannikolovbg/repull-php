...
/**
 * ListingPricingApplyResponse Class Doc Comment
 *
 * @package  Repull
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ListingPricingApplyResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'ListingPricingApplyResponse';
     ...
     * Sets applied
     *
     * @param int|null $applied Number of recommendations applied (apply action only).
     *
     * @return $this
     */
    public function setApplied(?int $applied): static
    {
        if (is_null($applied)) {
            array_push($this->openAPINullablesSetToNull, 'applied');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('applied', $nullablesSetToNull);
            if ($index !== FALSE) {
     ...
     * Sets declined
     *
     * @param int|null $declined Number of dates declined (decline action only).
     *
     * @return $this
     */
    public function setDeclined(?int $declined): static
    {
        if (is_null($declined)) {
            array_push($this->openAPINullablesSetToNull, 'declined');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('declined', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
