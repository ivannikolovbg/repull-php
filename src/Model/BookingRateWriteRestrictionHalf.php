...
/**
 * BookingRateWriteRestrictionHalf Class Doc Comment
 *
 ...
 */
class BookingRateWriteRestrictionHalf implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'BookingRateWriteRestrictionHalf';
    ...
    protected static array $openAPITypes = [
        'requested' => 'int',
        'fields' => 'string[]',
        'dates' => '\Repull\Model\BookingRestrictionRequestRow[]',
        'applied' => 'string',
        'verification' => '\Repull\Model\BookingRestrictionVerification',
        'errors' => 'array<string,mixed>[]',
        'rejection' => '\Repull\Model\BookingUpstreamFailure'
    ];
    ...
    public const APPLIED_NOT_REQUESTED = 'not_requested';
     ...
     * Sets requested
     *
     * @param int|null $requested How many updates carried a restriction. `0` when none did.
     *
     * @return $this
     */
     ...
     * Sets fields
     *
     * @param string[]|null $fields Every restriction asked for, across all updates.
     *
     * @return $this
     */
     ...
     * Gets dates
     *
     * @return \Repull\Model\BookingRestrictionRequestRow[]|null
     */
     ...
     * Sets dates
     *
     * @param \Repull\Model\BookingRestrictionRequestRow[]|null $dates Per update, the nights and the restrictions asked for them — so a partial result names exactly what did and did not change.
     *
     * @return $this
     */
     ...
     * Sets applied
     *
     * @param string|null $applied `not_requested` means no update carried a restriction and nothing was sent.
     *
     * @return $this
     */
     ...
     * Gets verification
     *
     * @return \Repull\Model\BookingRestrictionVerification|null
     */
    public function getVerification(): ?\Repull\Model\BookingRestrictionVerification
    {
     ...
     * Sets verification
     *
     * @param \Repull\Model\BookingRestrictionVerification|null $verification verification
     *
     * @return $this
     */
    public function setVerification(?\Repull\Model\BookingRestrictionVerification $verification): static
    {
     ...
     * Gets rejection
     *
     * @return \Repull\Model\BookingUpstreamFailure|null
     */
    public function getRejection(): ?\Repull\Model\BookingUpstreamFailure
    {
     ...
     * Sets rejection
     *
     * @param \Repull\Model\BookingUpstreamFailure|null $rejection rejection
     *
     * @return $this
     */
    public function setRejection(?\Repull\Model\BookingUpstreamFailure $rejection): static
    {
