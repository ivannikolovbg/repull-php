...
/**
 * AccountCreatedPayload Class Doc Comment
 *
 ...
 */
class AccountCreatedPayload implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'AccountCreatedPayload';
     ...
     * Sets provider
     *
     * @param string|null $provider PMS or channel provider id (e.g. airbnb, booking, hostaway).
     *
     * @return $this
     */
