...
/**
 * ListingPhotoUploadUrlResponse Class Doc Comment
 *
 ...
 */
class ListingPhotoUploadUrlResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'ListingPhotoUploadUrlResponse';
     ...
     * Sets upload_url
     *
     * @param string|null $upload_url PUT the raw file bytes here directly from the client. Not a Repull or vanio API endpoint — a signed storage URL.
     *
     * @return $this
     */
     ...
     * Sets token
     *
     * @param string|null $token Opaque upload token bound to this signed URL.
     *
     * @return $this
     */
     ...
     * Sets path
     *
     * @param string|null $path Storage path the photo will live at once uploaded. Pass this to `DELETE /v1/listings/{id}/photos` to remove it later.
     *
     * @return $this
     */
     ...
     * Sets public_url
     *
     * @param string|null $public_url Durable public URL for the photo once the upload completes. Attach it to the listing via `PUT /v1/listings/{id}/content` (`photos` field).
     *
     * @return $this
     */
    public function setPublicUrl(?string $public_url): static
    {
     ...
     * Sets expires_in
     *
     * @param int|null $expires_in Seconds until `uploadUrl` expires. Mint a new one via a fresh POST if the upload did not happen in time.
     *
     * @return $this
     */
