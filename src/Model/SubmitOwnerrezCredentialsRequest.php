<?php
/**
 * SubmitOwnerrezCredentialsRequest
 *
 * PHP version 8.1
 *
 * @package  Repull
...
/**
 * SubmitOwnerrezCredentialsRequest Class Doc Comment
 *
 * @package  Repull
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class SubmitOwnerrezCredentialsRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'submitOwnerrezCredentials_request';
     ...
     * Sets session_id
     *
     * @param string|null $session_id Connect session id from `POST /v1/connect/ownerrez`.
     *
     * @return $this
     */
     ...
     * Sets credentials
     *
     * @param array<string,mixed> $credentials Username + API token from OwnerRez → Settings → API.
     *
     * @return $this
     */
