...
class Error implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * Gets error
     *
     * @return \Repull\Model\ErrorError|null
     */
    public function getError(): ?\Repull\Model\ErrorError
    {
     ...
     * Sets error
     *
     * @param \Repull\Model\ErrorError|null $error error
     *
     * @return $this
     */
    public function setError(?\Repull\Model\ErrorError $error): static
    {
        if (is_null($error)) {
