...
/**
 * ConversationHost Class Doc Comment
 *
 ...
 */
class ConversationHost implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'ConversationHost';
     ...
     * Sets airbnb_id
     *
     * @param string|null $airbnb_id Airbnb-side host id.
     *
     * @return $this
     */
