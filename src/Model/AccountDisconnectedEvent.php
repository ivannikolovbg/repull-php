...
/**
 * AccountDisconnectedEvent Class Doc Comment
 *
 * @package  Repull
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class AccountDisconnectedEvent implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'AccountDisconnectedEvent';
    ...
    protected static array $openAPITypes = [
        ...
        'created_at' => '\DateTime',
        'api_version' => 'string',
        'data' => '\Repull\Model\AccountDisconnectedPayload'
    ];
     ...
     * Gets data
     *
     * @return \Repull\Model\AccountDisconnectedPayload
     */
    public function getData(): \Repull\Model\AccountDisconnectedPayload
    {
     ...
     * Sets data
     *
     * @param \Repull\Model\AccountDisconnectedPayload $data data
     *
     * @return $this
     */
    public function setData(\Repull\Model\AccountDisconnectedPayload $data): static
    {
        if (is_null($data)) {
