...
/**
 * AvailabilityWriteSettings Class Doc Comment
 *
 ...
 */
class AvailabilityWriteSettings implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'AvailabilityWriteSettings';
    ...
    public function setMinNights(?int $min_nights): static
    {
        ...
        if (($min_nights < 1)) {
            throw new InvalidArgumentException('invalid value for $min_nights when calling AvailabilityWriteSettings., must be bigger than or equal to 1.');
        }
    ...
    public function setMaxNights(?int $max_nights): static
    {
        ...
        if (($max_nights < 1)) {
            throw new InvalidArgumentException('invalid value for $max_nights when calling AvailabilityWriteSettings., must be bigger than or equal to 1.');
        }
