...
/**
 * SubmitVrboCredentialsRequest Class Doc Comment
 *
 * @package  Repull
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class SubmitVrboCredentialsRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'submitVrboCredentials_request';
     ...
     * Sets session_id
     *
     * @param string|null $session_id Connect session id from `POST /v1/connect/vrbo`.
     *
     * @return $this
     */
     ...
     * Sets credentials
     *
     * @param array<string,mixed> $credentials Activation handshake — Repull mints the Basic-Auth pair the host pastes into Vrbo Partner Central.
     *
     * @return $this
     */
