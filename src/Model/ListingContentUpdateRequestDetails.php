...
/**
 * ListingContentUpdateRequestDetails Class Doc Comment
 *
 ...
 */
class ListingContentUpdateRequestDetails implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'ListingContentUpdateRequest_details';
     ...
     * Sets property_type
     *
     * @param string|null $property_type Free-form property type; mapped to Airbnb's property-type group at publish time.
     *
     * @return $this
     */
     ...
     *
     * @param string|null $property_type_category Airbnb's `property_type_category`, e.g. `apartment`, `condominium`, `townhouse`.
     *
     * @return $this
     */
