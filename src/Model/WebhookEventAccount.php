...
/**
 * WebhookEventAccount Class Doc Comment
 *
 ...
 */
class WebhookEventAccount implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'WebhookEventAccount';
     ...
     * Sets id
     *
     * @param int|null $id Repull connection id.
     *
     * @return $this
     */
     ...
     *
     * @param string|null $external_account_id The provider's own account id.
     *
     * @return $this
     */
