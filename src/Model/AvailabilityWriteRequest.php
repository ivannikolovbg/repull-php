...
/**
 * AvailabilityWriteRequest Class Doc Comment
 *
 * @package  Repull
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class AvailabilityWriteRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'AvailabilityWriteRequest';
    ...
    public function setMinNights(?int $min_nights): static
    {
        ...
        if (($min_nights < 1)) {
            throw new InvalidArgumentException('invalid value for $min_nights when calling AvailabilityWriteRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setMaxNights(?int $max_nights): static
    {
        ...
        if (($max_nights < 1)) {
            throw new InvalidArgumentException('invalid value for $max_nights when calling AvailabilityWriteRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setDates(array $dates): static
    {
        ...
        if ((count($dates) > 731)) {
            throw new InvalidArgumentException('invalid value for $dates when calling AvailabilityWriteRequest., number of items must be less than or equal to 731.');
        }
