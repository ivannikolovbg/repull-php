...
/**
 * AiOperationCompletedPayload Class Doc Comment
 *
 ...
 */
class AiOperationCompletedPayload implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'AiOperationCompletedPayload';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('input_summary', $data ?? [], null);
     ...
     * Sets type
     *
     * @param string|null $type AI operation kind — e.g. respond-to-guest, price-suggestion, review-response.
     *
     * @return $this
     */
    ...
    {
        return $this->container['input_summary'];
    }

    /**
     * Sets input_summary
     *
     * @param string|null $input_summary input_summary
     *
     * @return $this
     */
    public function setInputSummary(?string $input_summary): static
    {
        if (is_null($input_summary)) {
            throw new InvalidArgumentException('non-nullable input_summary cannot be null');
        }
        $this->container['input_summary'] = $input_summary;
     ...
     * Sets output
     *
     * @param array<string,mixed>|null $output Operation-specific output object.
     *
     * @return $this
     */
     ...
     * Sets tokens_used
     *
     * @param int|null $tokens_used tokens_used
     *
     * @return $this
     */
    public function setTokensUsed(?int $tokens_used): static
    {
