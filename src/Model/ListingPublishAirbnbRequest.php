...
/**
 * ListingPublishAirbnbRequest Class Doc Comment
 *
 ...
 */
class ListingPublishAirbnbRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'ListingPublishAirbnbRequest';
     ...
     * @return int|null
     */
    public function getAirbnbConnectionId(): ?int
    {
     ...
     *
     * @param int|null $airbnb_connection_id Existing Airbnb connection row id
     *
     * @return $this
     */
    public function setAirbnbConnectionId(?int $airbnb_connection_id): static
    {
     ...
     * Sets host_id
     *
     * @param string|null $host_id Airbnb host id (required for first-time creates)
     *
     * @return $this
     */
     ...
     * Sets force
     *
     * @param bool|null $force Re-push every section, ignoring dirty-fields tracking
     *
     * @return $this
     */
