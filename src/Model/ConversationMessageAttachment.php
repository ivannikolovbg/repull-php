 ...
 */
class ConversationMessageAttachment implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'ConversationMessageAttachment';
