<?php
/**
 * SubmitBeds24CredentialsRequest
 *
 * PHP version 8.1
 *
 * @package  Repull
...
/**
 * SubmitBeds24CredentialsRequest Class Doc Comment
 *
 * @package  Repull
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class SubmitBeds24CredentialsRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'submitBeds24Credentials_request';
     ...
     * Sets session_id
     *
     * @param string|null $session_id Connect session id from `POST /v1/connect/beds24`.
     *
     * @return $this
     */
     ...
     * Sets credentials
     *
     * @param array<string,mixed> $credentials API key + prop key from Beds24 → Settings → Apps & Integrations.
     *
     * @return $this
     */
