<?php
/**
 * UpdateAirbnbListingAmenities200ResponseData
 *
 * PHP version 8.1
 *
 * @package  Repull
...
/**
 * UpdateAirbnbListingAmenities200ResponseData Class Doc Comment
 *
 * @package  Repull
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class UpdateAirbnbListingAmenities200ResponseData implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'update_airbnb_listing_amenities_200_response_data';
     ...
     * @return int|null
     */
    public function getAmenities(): ?int
    {
     ...
     * Sets amenities
     *
     * @param int|null $amenities How many regular amenities were written.
     *
     * @return $this
     */
    public function setAmenities(?int $amenities): static
    {
     ...
     * @return int|null
     */
    public function getAccessibilityAmenities(): ?int
    {
     ...
     *
     * @param int|null $accessibility_amenities How many accessibility amenities were written.
     *
     * @return $this
     */
    public function setAccessibilityAmenities(?int $accessibility_amenities): static
    {
