...
/**
 * AirbnbPhotoPosition Class Doc Comment
 *
 ...
 */
class AirbnbPhotoPosition implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'AirbnbPhotoPosition';
     ...
     * Sets photo_id
     *
     * @param string|null $photo_id Airbnb-side photo id.
     *
     * @return $this
     */
     ...
     * Sets sort_order
     *
     * @param int|null $sort_order Position in the tour, 1 first.
     *
     * @return $this
     */
