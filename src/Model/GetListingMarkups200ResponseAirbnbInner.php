<?php
/**
 * GetListingMarkups200ResponseAirbnbInner
 *
 * PHP version 8.1
 *
 * @package  Repull
...
/**
 * GetListingMarkups200ResponseAirbnbInner Class Doc Comment
 *
 * @package  Repull
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class GetListingMarkups200ResponseAirbnbInner implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'get_listing_markups_200_response_airbnb_inner';
     ...
     * Sets airbnb_id
     *
     * @param string|null $airbnb_id Airbnb listing id.
     *
     * @return $this
     */
     ...
     * Sets markup_percent
     *
     * @param float|null $markup_percent Percent added to the listing's price on Airbnb. 35 = +35%. `null` = none.
     *
     * @return $this
     */
