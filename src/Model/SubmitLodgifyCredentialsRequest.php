<?php
/**
 * SubmitLodgifyCredentialsRequest
 *
 * PHP version 8.1
 *
 * @package  Repull
...
/**
 * SubmitLodgifyCredentialsRequest Class Doc Comment
 *
 * @package  Repull
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class SubmitLodgifyCredentialsRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'submitLodgifyCredentials_request';
     ...
     * Sets session_id
     *
     * @param string|null $session_id Connect session id from `POST /v1/connect/lodgify`.
     *
     * @return $this
     */
     ...
     * Sets credentials
     *
     * @param array<string,mixed> $credentials API key from Lodgify → Settings → Public API.
     *
     * @return $this
     */
