 ...
 */
class AirbnbPublishResult implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'AirbnbPublishResult';
     ...
     * Sets published
     *
     * @param bool $published True only when EVERY attempted section reached Airbnb.
     *
     * @return $this
     */
     ...
     * Sets sections
     *
     * @param string[] $sections Sections that landed on Airbnb.
     *
     * @return $this
     */
     ...
     * Gets errors
     *
     * @return \Repull\Model\PublishSectionError[]
     */
     ...
     * Sets errors
     *
     * @param \Repull\Model\PublishSectionError[] $errors Per-section failures. Empty when `published` is true.
     *
     * @return $this
     */
     ...
     * Sets reason
     *
     * @param string|null $reason Set when the publish never started at all (no connection, address missing, subscription gate).
     *
     * @return $this
     */
     ...
     * Sets locked_fields
     *
     * @param string[] $locked_fields Fields Airbnb will not let this listing change — collected from the failures above and from the `locked_attributes` Airbnb recorded for the listing. Sending them again returns success and changes nothing.
     *
     * @return $this
     */
