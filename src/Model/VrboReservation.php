...
/**
 * VrboReservation Class Doc Comment
 *
 ...
 */
class VrboReservation implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'VrboReservation';
