...
/**
 * ReplayWebhookDeliveryRequest Class Doc Comment
 *
 * @package  Repull
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ReplayWebhookDeliveryRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'replay_webhook_delivery_request';
     ...
     * Sets force
     *
     * @param bool|null $force Replay even though this delivery already succeeded. Still counts against the 3-per-hour limit.
     *
     * @return $this
     */
