...
/**
 * CalendarUpdatedEvent Class Doc Comment
 *
 * @package  Repull
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class CalendarUpdatedEvent implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'CalendarUpdatedEvent';
    ...
    protected static array $openAPITypes = [
        ...
        'created_at' => '\DateTime',
        'api_version' => 'string',
        'data' => '\Repull\Model\CalendarUpdatedPayload'
    ];
     ...
     * Gets data
     *
     * @return \Repull\Model\CalendarUpdatedPayload
     */
    public function getData(): \Repull\Model\CalendarUpdatedPayload
    {
     ...
     * Sets data
     *
     * @param \Repull\Model\CalendarUpdatedPayload $data data
     *
     * @return $this
     */
    public function setData(\Repull\Model\CalendarUpdatedPayload $data): static
    {
        if (is_null($data)) {
