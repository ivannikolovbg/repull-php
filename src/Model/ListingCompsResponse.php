...
/**
 * ListingCompsResponse Class Doc Comment
 *
 ...
 */
class ListingCompsResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'ListingCompsResponse';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('radius_km', $data ?? [], null);
     ...
     * Sets radius_km
     *
     * @param float|null $radius_km radius_km
     *
     * @return $this
     */
    public function setRadiusKm(?float $radius_km): static
    {
        if (is_null($radius_km)) {
            throw new InvalidArgumentException('non-nullable radius_km cannot be null');
        }
     ...
     * Gets data
     *
     * @return \Repull\Model\ListingComp[]|null
     */
     ...
     * Sets data
     *
     * @param \Repull\Model\ListingComp[]|null $data data
     *
     * @return $this
     */
     ...
     * Sets warning
     *
     * @param string|null $warning Present (and `data` empty) when the source listing has no coordinates.
     *
     * @return $this
     */
