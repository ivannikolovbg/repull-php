...
/**
 * MigrationReport Class Doc Comment
 *
 * @package  Repull
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class MigrationReport implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'MigrationReport';
    ...
    protected static array $openAPITypes = [
        ...
        'issues' => '\Repull\Model\MigrationReportIssuesInner[]'
    ];
     ...
     * Sets capabilities
     *
     * @param array<string,mixed>|null $capabilities Per source provider: what it can carry, per entity — `{ read: { listings: { level, notes } … }, write: { … } }`, level `full` | `partial` | `none`.
     *
     * @return $this
     */
     ...
     * Gets issues
     *
     * @return \Repull\Model\MigrationReportIssuesInner[]|null
     */
     ...
     * Sets issues
     *
     * @param \Repull\Model\MigrationReportIssuesInner[]|null $issues issues
     *
     * @return $this
     */
