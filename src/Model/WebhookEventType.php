...
enum WebhookEventType: string
{
    ...
    case RESERVATION_UPDATED = 'reservation.updated';

    case RESERVATION_CANCELLED = 'reservation.cancelled';

    case RESERVATION_MESSAGE_RECEIVED = 'reservation.message.received';

    case RESERVATION_ALTERATION_CREATED = 'reservation.alteration.created';
    ...
    case REVIEW_RESPONDED = 'review.responded';

    case AI_OPERATION_COMPLETED = 'ai.operation.completed';

    case AI_OPERATION_FAILED = 'ai.operation.failed';

    case PAYMENT_COMPLETED = 'payment.completed';

    case PAYMENT_REFUNDED = 'payment.refunded';

    case MIGRATION_COMPLETED = 'migration.completed';

    case MIGRATION_FAILED = 'migration.failed';
