...
/**
 * PropertyAvailabilityDay Class Doc Comment
 *
 ...
 */
class PropertyAvailabilityDay implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'PropertyAvailabilityDay';
    ...
    public function listInvalidProperties(): array
    {
        ...
        if ($this->container['min_nights'] === null) {
            $invalidProperties[] = "'min_nights' can't be null";
        }
     ...
     * Sets date
     *
     * @param \DateTime $date The calendar date, ISO `YYYY-MM-DD`.
     *
     * @return $this
     */
     ...
     * Sets available
     *
     * @param bool $available Whether the property is bookable on this date. `false` when the calendar marks the date booked or blocked. Only dates we actually hold a calendar row for appear in `days`, so this is never a guess — a date with no data is listed in `coverage.missingDates` instead.
     *
     * @return $this
     */
     ...
     * Sets price
     *
     * @param float $price Nightly price for this date in the property currency. Falls back to the property's default nightly price when the calendar row itself carries no price.
     *
     * @return $this
     */
     ...
     * Sets min_nights
     *
     * @param int $min_nights Minimum-stay requirement for a stay starting on this date. Falls back to the listing-level default min-nights when the calendar row carries none.
     *
     * @return $this
     */
