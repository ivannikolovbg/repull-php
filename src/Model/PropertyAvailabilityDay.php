...
class PropertyAvailabilityDay implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * Sets available
     *
     * @param bool $available Whether the property is bookable on this date. `false` when the channel calendar marks the date unavailable (stop-sell / blocked).
     *
     * @return $this
     */
     ...
     * Sets price
     *
     * @param float $price Nightly price for this date in the property currency. Falls back to the property's default nightly price for dates with no explicit calendar override.
     *
     * @return $this
     */
     ...
     * Sets min_nights
     *
     * @param int $min_nights Minimum-stay requirement for a stay starting on this date.
     *
     * @return $this
     */
