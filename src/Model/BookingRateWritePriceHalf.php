...
/**
 * BookingRateWritePriceHalf Class Doc Comment
 *
 ...
 */
class BookingRateWritePriceHalf implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'BookingRateWritePriceHalf';
     ...
     * Sets requested
     *
     * @param int|null $requested How many updates carried a price.
     *
     * @return $this
     */
     ...
     * Sets applied
     *
     * @param string|null $applied What is known about the amounts. Same vocabulary as the top-level `applied`, for this half alone.
     *
     * @return $this
     */
