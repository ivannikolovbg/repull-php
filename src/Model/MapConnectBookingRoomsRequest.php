...
/**
 * MapConnectBookingRoomsRequest Class Doc Comment
 *
 ...
 */
class MapConnectBookingRoomsRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'MapConnectBookingRoomsRequest';
    ...
    protected static array $openAPITypes = [
        'session_id' => 'string',
        'mappings' => '\Repull\Model\BookingRoomMapping[]'
    ];
     ...
     * Gets mappings
     *
     * @return \Repull\Model\BookingRoomMapping[]
     */
     ...
     * Sets mappings
     *
     * @param \Repull\Model\BookingRoomMapping[] $mappings mappings
     *
     * @return $this
     */
    public function setMappings(array $mappings): static
    {
        ...
        if ((count($mappings) < 1)) {
            throw new InvalidArgumentException('invalid length for $mappings when calling MapConnectBookingRoomsRequest., number of items must be greater than or equal to 1.');
        }
