...
/**
 * ListingSegmentRecommendation Class Doc Comment
 *
 ...
 */
class ListingSegmentRecommendation implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'ListingSegmentRecommendation';
    ...
    public const KIND_LOW_DNA_COVERAGE = 'low_dna_coverage';
    public const KIND_SELF_NOT_SCORED = 'self_not_scored';
    public const KIND_MY_SEGMENT = 'my_segment';
    public const KIND_TIER_UPLIFT = 'tier_uplift';
    public const KIND_SEGMENT_NOT_FOUND = 'segment_not_found';
    public const KIND_NO_MARKET_SIGNAL = 'no_market_signal';
    public const KIND_NO_GEO = 'no_geo';
    ...
    {
        return [
            self::KIND_LOW_DNA_COVERAGE,
            self::KIND_SELF_NOT_SCORED,
            self::KIND_MY_SEGMENT,
            self::KIND_TIER_UPLIFT,
            self::KIND_SEGMENT_NOT_FOUND,
            self::KIND_NO_MARKET_SIGNAL,
            self::KIND_NO_GEO,
        ];
    }
    ...
    public function listInvalidProperties(): array
    {
        ...
        $allowedValues = self::getKindAllowableValues();
     ...
     * Sets kind
     *
     * @param string|null $kind Stable identifier for the recommendation kind. SDKs can switch on this safely.
     *
     * @return $this
     */
     ...
     * Sets evidence
     *
     * @param array<string,mixed>|null $evidence evidence
     *
     * @return $this
     */
