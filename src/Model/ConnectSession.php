...
/**
 * ConnectSession Class Doc Comment
 *
 ...
 */
class ConnectSession implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'ConnectSession';
     ...
     * Sets state
     *
     * @param string|null $state Echoed back from the request body for SDK consumers that pass an opaque correlation token.
     *
     * @return $this
     */
