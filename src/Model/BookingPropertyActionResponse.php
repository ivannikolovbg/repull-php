...
/**
 * BookingPropertyActionResponse Class Doc Comment
 *
 * @package  Repull
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class BookingPropertyActionResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'BookingPropertyActionResponse';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('selling', $data ?? [], null);
    }
    ...
    public function listInvalidProperties(): array
    {
        ...
        if ($this->container['selling'] === null) {
            $invalidProperties[] = "'selling' can't be null";
        }
     ...
     * Sets hotel_id
     *
     * @param string $hotel_id The Booking.com property that was acted on. Always read it back — a listing can be mapped to several, and this states which one changed.
     *
     * @return $this
     */
     ...
     *
     * @param string|null $room_booking_id Booking.com's own room id the availability write addressed.
     *
     * @return $this
     */
     ...
     * Sets selling
     *
     * @param bool $selling Whether the property is now on sale. **This is the state of the property on Booking.com, not of the listing in Repull** — `active` (what Repull bills and serves) is untouched by both actions and is deliberately not echoed here so the two can never be read as one field.
     *
     * @return $this
     */
    public function setSelling(bool $selling): static
    {
        if (is_null($selling)) {
            throw new InvalidArgumentException('non-nullable selling cannot be null');
        }
