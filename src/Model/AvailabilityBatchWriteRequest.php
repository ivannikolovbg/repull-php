...
/**
 * AvailabilityBatchWriteRequest Class Doc Comment
 *
 * @package  Repull
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class AvailabilityBatchWriteRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'AvailabilityBatchWriteRequest';
    ...
    public function listInvalidProperties(): array
    {
        ...
        if ((count($this->container['dates']) > 731)) {
            $invalidProperties[] = "invalid value for 'dates', number of items must be less than or equal to 731.";
        }

        if ($this->container['property_ids'] === null) {
            $invalidProperties[] = "'property_ids' can't be null";
        }
        if ((count($this->container['property_ids']) > 500)) {
            $invalidProperties[] = "invalid value for 'property_ids', number of items must be less than or equal to 500.";
        }
     ...
     * Sets available
     *
     * @param bool|null $available Block or unblock the dates.
     *
     * @return $this
     */
     ...
     * Sets price
     *
     * @param float|null $price Nightly base price.
     *
     * @return $this
     */
    ...
    public function setMinNights(?int $min_nights): static
    {
        if (is_null($min_nights)) {
            throw new InvalidArgumentException('non-nullable min_nights cannot be null');
        }

        if (($min_nights < 1)) {
            throw new InvalidArgumentException('invalid value for $min_nights when calling AvailabilityBatchWriteRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setMaxNights(?int $max_nights): static
    {
        if (is_null($max_nights)) {
            throw new InvalidArgumentException('non-nullable max_nights cannot be null');
        }

        if (($max_nights < 1)) {
            throw new InvalidArgumentException('invalid value for $max_nights when calling AvailabilityBatchWriteRequest., must be bigger than or equal to 1.');
        }
     ...
     * Sets dates
     *
     * @param \DateTime[] $dates ISO dates. Capped at 731 — Airbnb refuses calendar writes spanning more.
     *
     * @return $this
     */
    public function setDates(array $dates): static
    {
        ...
        if ((count($dates) > 731)) {
            throw new InvalidArgumentException('invalid value for $dates when calling AvailabilityBatchWriteRequest., number of items must be less than or equal to 731.');
        }
     ...
     * Sets property_ids
     *
     * @param int[] $property_ids property_ids
     *
     * @return $this
     */
    public function setPropertyIds(array $property_ids): static
    {
        if (is_null($property_ids)) {
            throw new InvalidArgumentException('non-nullable property_ids cannot be null');
        }

        if ((count($property_ids) > 500)) {
            throw new InvalidArgumentException('invalid value for $property_ids when calling AvailabilityBatchWriteRequest., number of items must be less than or equal to 500.');
        }
