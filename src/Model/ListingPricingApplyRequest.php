...
/**
 * ListingPricingApplyRequest Class Doc Comment
 *
 * @package  Repull
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ListingPricingApplyRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'ListingPricingApplyRequest';
     ...
     * Sets dates
     *
     * @param \DateTime[] $dates Dates the action applies to. Must match dates that have a `pending` recommendation; others are silently skipped.
     *
     * @return $this
     */
