...
/**
 * ListingPullAirbnbRequest Class Doc Comment
 *
 ...
 */
class ListingPullAirbnbRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'ListingPullAirbnbRequest';
     ...
     *
     * @param string|null $airbnb_connection_id Pull through this specific Airbnb connection instead of the listing's primary one. Use when a listing carries several connections (merged properties, host migrations) — the ids come from `GET /v1/listings/{id}/publish-status`.
     *
     * @return $this
     */
