...
/**
 * BulkPricingItem Class Doc Comment
 *
 ...
 */
class BulkPricingItem implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'BulkPricingItem';
    ...
    public function listInvalidProperties(): array
    {
        ...
        if ((count($this->container['dates']) < 1)) {
    ...
    public function setDates(array $dates): static
    {
        ...
        if ((count($dates) < 1)) {
            throw new InvalidArgumentException('invalid length for $dates when calling BulkPricingItem., number of items must be greater than or equal to 1.');
        }
