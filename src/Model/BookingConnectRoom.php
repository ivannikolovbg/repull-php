...
class BookingConnectRoom implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * Sets room_id
     *
     * @param int $room_id Repull-side `listings_booking_rooms.id`. Pass this back in the mapping submission.
     *
     * @return $this
     */
     ...
     *
     * @param int|null $current_listing_id Currently mapped Repull listing ID, or null if not yet mapped.
     *
     * @return $this
     */
     ...
     *
     * @param int|null $room_booking_id Booking.com-side room ID (used internally for `listing_platform_links`).
     *
     * @return $this
     */
    public function setRoomBookingId(?int $room_booking_id): static
    {
