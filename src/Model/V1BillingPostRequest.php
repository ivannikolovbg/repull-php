...
/**
 * V1BillingPostRequest Class Doc Comment
 *
 * @package  Repull
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class V1BillingPostRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = '_v1_billing_post_request';
     ...
     * @return string[]
     */
    public static function getPlanAllowableValues()
    {
        return [
            self::PLAN_STARTER,
            self::PLAN_GROWTH,
    ...
    public function listInvalidProperties(): array
    {
        ...
        $allowedValues = self::getPlanAllowableValues();
