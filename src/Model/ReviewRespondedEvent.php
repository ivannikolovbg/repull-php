...
/**
 * ReviewRespondedEvent Class Doc Comment
 *
 * @package  Repull
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ReviewRespondedEvent implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'ReviewRespondedEvent';
     ...
     * Gets data
     *
     * @return \Repull\Model\ReviewRespondedPayload
     */
    public function getData(): \Repull\Model\ReviewRespondedPayload
    {
     ...
     * Sets data
     *
     * @param \Repull\Model\ReviewRespondedPayload $data data
     *
     * @return $this
     */
    public function setData(\Repull\Model\ReviewRespondedPayload $data): static
    {
        if (is_null($data)) {
