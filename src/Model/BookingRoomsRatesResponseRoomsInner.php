<?php
/**
 * BookingRoomsRatesResponseRoomsInner
 *
 * PHP version 8.1
 *
 * @package  Repull
...
/**
 * BookingRoomsRatesResponseRoomsInner Class Doc Comment
 *
 * @package  Repull
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class BookingRoomsRatesResponseRoomsInner implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'BookingRoomsRatesResponse_rooms_inner';
     ...
     * Sets room_id
     *
     * @param string|null $room_id Booking.com room id — use as `roomId` in an ARI update.
     *
     * @return $this
     */
     ...
     * Gets rates
     *
     * @return \Repull\Model\BookingRoomsRatesResponseRoomsInnerRatesInner[]|null
     */
     ...
     * Sets rates
     *
     * @param \Repull\Model\BookingRoomsRatesResponseRoomsInnerRatesInner[]|null $rates rates
     *
     * @return $this
     */
