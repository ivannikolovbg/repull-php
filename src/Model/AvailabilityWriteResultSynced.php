...
/**
 * AvailabilityWriteResultSynced Class Doc Comment
 *
 ...
 */
class AvailabilityWriteResultSynced implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'AvailabilityWriteResult_synced';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('auth_errors', $data ?? [], null);
    }
     ...
     * @return int|null
     */
    public function getAuthErrors(): ?int
    {
        return $this->container['auth_errors'];
    }

    /**
     * Sets auth_errors
     *
     * @param int|null $auth_errors Channels whose token has expired — these need reconnecting, not retrying.
     *
     * @return $this
     */
    public function setAuthErrors(?int $auth_errors): static
    {
        if (is_null($auth_errors)) {
            throw new InvalidArgumentException('non-nullable auth_errors cannot be null');
        }
        $this->container['auth_errors'] = $auth_errors;
