<?php
/**
 * SetAirbnbListingCoverPhotoRequest
 *
 * PHP version 8.1
 *
 * @package  Repull
...
/**
 * SetAirbnbListingCoverPhotoRequest Class Doc Comment
 *
 * @package  Repull
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class SetAirbnbListingCoverPhotoRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'set_airbnb_listing_cover_photo_request';
     ...
     * Sets photo_id
     *
     * @param string $photo_id Airbnb photo id (`photoAirbnbId` from `GET /photos`) to lead the tour.
     *
     * @return $this
     */
