...
class SendMessageRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    public function listInvalidProperties(): array
    {
        ...
        if ((mb_strlen($this->container['message']) > 4000)) {
     ...
     * Sets message
     *
     * @param string $message The text to send the guest.
     *
     * @return $this
     */
    public function setMessage(string $message): static
    {
        ...
        if ((mb_strlen($message) < 1)) {
            throw new InvalidArgumentException('invalid length for $message when calling SendMessageRequest., must be bigger than or equal to 1.');
        }
