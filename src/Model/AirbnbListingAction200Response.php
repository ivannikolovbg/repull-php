<?php
/**
 * AirbnbListingAction200Response
 *
 * PHP version 8.1
 *
 * @package  Repull
...
/**
 * AirbnbListingAction200Response Class Doc Comment
 *
 * @package  Repull
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class AirbnbListingAction200Response implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'airbnb_listing_action_200_response';
    ...
    protected static array $openAPITypes = [
        ...
        'action' => 'string',
        'channel' => 'string',
        'result' => '\Repull\Model\AirbnbPublishResult',
     ...
     * Gets result
     *
     * @return \Repull\Model\AirbnbPublishResult|null
     */
    public function getResult(): ?\Repull\Model\AirbnbPublishResult
    {
     ...
     * Sets result
     *
     * @param \Repull\Model\AirbnbPublishResult|null $result result
     *
     * @return $this
     */
    public function setResult(?\Repull\Model\AirbnbPublishResult $result): static
    {
        if (is_null($result)) {
     ...
     *
     * @param string|null $airbnb_connection_id airbnb_connection_id
     *
     * @return $this
     */
     ...
     * Sets live
     *
     * @param bool|null $live Whether the Airbnb listing is taking bookings after this call. `false` after `unlist`, `true` after `relist`.
     *
     * @return $this
     */
     ...
     * Sets verified
     *
     * @param bool|null $verified True when the result was confirmed by reading the listing back from Airbnb (done on `unlist`: Airbnb accepting the call is not proof the listing came down).
     *
     * @return $this
     */
