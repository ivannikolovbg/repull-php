...
/**
 * AirbnbSafetyDisclosuresWriteRequest Class Doc Comment
 *
 ...
 */
class AirbnbSafetyDisclosuresWriteRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'AirbnbSafetyDisclosuresWriteRequest';
    ...
    protected static array $openAPITypes = [
        'disclosures' => '\Repull\Model\AirbnbSafetyDisclosure[]'
    ];
    ...
    public function listInvalidProperties(): array
    {
        ...
        if ($this->container['disclosures'] === null) {
            $invalidProperties[] = "'disclosures' can't be null";
        }
        if ((count($this->container['disclosures']) < 1)) {
            $invalidProperties[] = "invalid value for 'disclosures', number of items must be greater than or equal to 1.";
        }
     ...
     * Gets disclosures
     *
     * @return \Repull\Model\AirbnbSafetyDisclosure[]
     */
     ...
     * Sets disclosures
     *
     * @param \Repull\Model\AirbnbSafetyDisclosure[] $disclosures disclosures
     *
     * @return $this
     */
    public function setDisclosures(array $disclosures): static
    {
        ...
        if ((count($disclosures) < 1)) {
            throw new InvalidArgumentException('invalid length for $disclosures when calling AirbnbSafetyDisclosuresWriteRequest., number of items must be greater than or equal to 1.');
        }
