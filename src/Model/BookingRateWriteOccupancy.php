...
/**
 * BookingRateWriteOccupancy Class Doc Comment
 *
 ...
 */
class BookingRateWriteOccupancy implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'BookingRateWriteOccupancy';
    ...
    public const SOURCE_RATE_PLAN = 'rate_plan';
     ...
     * Sets index
     *
     * @param int|null $index Position of the update in the request `updates[]`.
     *
     * @return $this
     */
     ...
     * Sets value
     *
     * @param int|null $value The party size the amount was written against.
     *
     * @return $this
     */
     ...
     * Sets source
     *
     * @param string|null $source `request` — you stated it. `rate_plan` — Booking.com's maximum occupancy for this rate plan. `room` — Booking.com's room definition, used when the rate plan did not state one.
     *
     * @return $this
     */
