 ...
 */
class BookingRoomMapping implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'BookingRoomMapping';
     ...
     * Sets room_id
     *
     * @param int $room_id Repull-side `listings_booking_rooms.id` from `listConnectBookingRooms`.
     *
     * @return $this
     */
     ...
     * Sets listing_id
     *
     * @param int|null $listing_id Repull listing to bind to this room. `null` to unmap.
     *
     * @return $this
     */
