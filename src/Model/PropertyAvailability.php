 ...
 */
class PropertyAvailability implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'PropertyAvailability';
     ...
     * Sets property_id
     *
     * @param string $property_id Repull property id (equal to `listings.id`), emitted as a string like every other id in the API.
     *
     * @return $this
     */
     ...
     * Sets currency
     *
     * @param string $currency ISO 4217 currency code for the nightly prices in `days`.
     *
     * @return $this
     */
     ...
     * Gets days
     *
     * @return \Repull\Model\PropertyAvailabilityDay[]
     */
