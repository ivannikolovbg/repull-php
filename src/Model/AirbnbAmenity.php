...
/**
 * AirbnbAmenity Class Doc Comment
 *
 ...
 */
class AirbnbAmenity implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'AirbnbAmenity';
     ...
     * Sets id
     *
     * @param string|null $id Airbnb amenity id (e.g. `wifi`, `bathroom_step_free_access`).
     *
     * @return $this
     */
     ...
     * Sets is_present
     *
     * @param bool|null $is_present Whether the amenity is present on the listing.
     *
     * @return $this
     */
     ...
     * Sets instruction
     *
     * @param string|null $instruction Optional host-supplied instruction for the amenity.
     *
     * @return $this
     */
