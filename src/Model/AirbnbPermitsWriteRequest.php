 ...
 */
class AirbnbPermitsWriteRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'AirbnbPermitsWriteRequest';
    ...
    protected static array $openAPITypes = [
        'permits' => '\Repull\Model\AirbnbPermitsWriteRequestPermitsInner[]'
    ];
    ...
    public function listInvalidProperties(): array
    {
        ...
        if ((count($this->container['permits']) < 1)) {
            $invalidProperties[] = "invalid value for 'permits', number of items must be greater than or equal to 1.";
        }
     ...
     * Gets permits
     *
     * @return \Repull\Model\AirbnbPermitsWriteRequestPermitsInner[]
     */
     ...
     * Sets permits
     *
     * @param \Repull\Model\AirbnbPermitsWriteRequestPermitsInner[] $permits permits
     *
     * @return $this
     */
    public function setPermits(array $permits): static
    {
        ...
        if ((count($permits) < 1)) {
            throw new InvalidArgumentException('invalid length for $permits when calling AirbnbPermitsWriteRequest., number of items must be greater than or equal to 1.');
        }
