...
/**
 * CustomSchemaSummary Class Doc Comment
 *
 ...
 */
class CustomSchemaSummary implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'CustomSchemaSummary';
    ...
    public function setMappings(array $mappings): static
    {
        ...
        if ((count($mappings) > 50)) {
            throw new InvalidArgumentException('invalid value for $mappings when calling CustomSchemaSummary., number of items must be less than or equal to 50.');
        }
        if ((count($mappings) < 1)) {
            throw new InvalidArgumentException('invalid length for $mappings when calling CustomSchemaSummary., number of items must be greater than or equal to 1.');
        }
