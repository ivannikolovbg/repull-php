...
/**
 * AirbnbAlterationCreateRequest Class Doc Comment
 *
 ...
 */
class AirbnbAlterationCreateRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'AirbnbAlterationCreateRequest';
     ...
     *
     * @param string $confirmation_code Airbnb confirmation code of the reservation to alter. `GET /v1/channels/airbnb/reservations` lists them.
     *
     * @return $this
     */
     ...
     * Sets check_out
     *
     * @param \DateTime|null $check_out New check-out date, `YYYY-MM-DD`. Must be after `check_in` when both are sent.
     *
     * @return $this
     */
     ...
     *
     * @param int|null $number_of_guests New guest count for the stay.
     *
     * @return $this
     */
    public function setNumberOfGuests(?int $number_of_guests): static
    {
        ...
        if (($number_of_guests < 1)) {
            throw new InvalidArgumentException('invalid value for $number_of_guests when calling AirbnbAlterationCreateRequest., must be bigger than or equal to 1.');
        }
     ...
     * Sets total_price
     *
     * @param float|null $total_price New total for the whole stay, in the listing currency. Sent to Airbnb as the alteration's price override.
     *
     * @return $this
     */
    public function setTotalPrice(?float $total_price): static
    {
        ...
        if (($total_price < 0)) {
            throw new InvalidArgumentException('invalid value for $total_price when calling AirbnbAlterationCreateRequest., must be bigger than or equal to 0.');
        }
     ...
     *
     * @param string|null $airbnb_listing_id The transfer target as the **Airbnb** listing id, for callers who hold that instead of the Repull id. Prefer `listing_id`. Sending both is allowed only when they name the same listing.
     *
     * @return $this
     */
