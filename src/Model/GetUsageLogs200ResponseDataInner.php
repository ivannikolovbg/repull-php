<?php
/**
 * GetUsageLogs200ResponseDataInner
 *
 * PHP version 8.1
 *
 * @package  Repull
...
/**
 * GetUsageLogs200ResponseDataInner Class Doc Comment
 *
 * @package  Repull
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class GetUsageLogs200ResponseDataInner implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'get_usage_logs_200_response_data_inner';
    ...
    protected static array $setters = [
        ...
        'request_bytes' => 'setRequestBytes',
        'response_bytes' => 'setResponseBytes',
    ...
    protected static array $getters = [
        ...
        'request_bytes' => 'getRequestBytes',
        'response_bytes' => 'getResponseBytes',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('request_bytes', $data ?? [], null);
        $this->setIfExists('response_bytes', $data ?? [], null);
    ...
    public function setOperationId(?string $operation_id): static
    {
        if (is_null($operation_id)) {
            array_push($this->openAPINullablesSetToNull, 'operation_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('operation_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    {
        return $this->container['request_bytes'];
    }

    /**
     * Sets request_bytes
     *
     * @param int|null $request_bytes request_bytes
     *
     * @return $this
     */
    public function setRequestBytes(?int $request_bytes): static
    {
        if (is_null($request_bytes)) {
            array_push($this->openAPINullablesSetToNull, 'request_bytes');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('request_bytes', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['request_bytes'] = $request_bytes;
    ...
    {
        return $this->container['response_bytes'];
    }

    /**
     * Sets response_bytes
     *
     * @param int|null $response_bytes response_bytes
     *
     * @return $this
     */
    public function setResponseBytes(?int $response_bytes): static
    {
        if (is_null($response_bytes)) {
            array_push($this->openAPINullablesSetToNull, 'response_bytes');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('response_bytes', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['response_bytes'] = $response_bytes;
