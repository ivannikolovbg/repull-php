<?php
/**
 * ListingPricingResponseCompSummary
 *
 * PHP version 8.1
 *
 * @package  Repull
...
/**
 * ListingPricingResponseCompSummary Class Doc Comment
 *
 ...
 */
class ListingPricingResponseCompSummary implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'ListingPricingResponse_compSummary';
     ...
     * Sets avg_price
     *
     * @param float|null $avg_price avg_price
     *
     * @return $this
     */
    public function setAvgPrice(?float $avg_price): static
    {
        if (is_null($avg_price)) {
            array_push($this->openAPINullablesSetToNull, 'avg_price');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('avg_price', $nullablesSetToNull);
            if ($index !== FALSE) {
