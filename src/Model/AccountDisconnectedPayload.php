...
/**
 * AccountDisconnectedPayload Class Doc Comment
 *
 ...
 */
class AccountDisconnectedPayload implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'AccountDisconnectedPayload';
    ...
    protected static array $setters = [
        ...
        'disconnected_at' => 'setDisconnectedAt',
        'reason' => 'setReason'
    ];
    ...
    protected static array $getters = [
        ...
        'disconnected_at' => 'getDisconnectedAt',
        'reason' => 'getReason'
    ];
    ...
    public const REASON_REFRESH_TOKEN_REJECTED = 'refresh_token_rejected';
    public const REASON_MANUAL_DISCONNECT = 'manual_disconnect';
    public const REASON_AUTH_EXPIRED = 'auth_expired';
    public const REASON_REVOKED_UPSTREAM = 'revoked_upstream';
    ...
    {
        return [
            self::REASON_REFRESH_TOKEN_REJECTED,
            self::REASON_MANUAL_DISCONNECT,
            self::REASON_AUTH_EXPIRED,
            self::REASON_REVOKED_UPSTREAM,
        ];
    }
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('disconnected_at', $data ?? [], null);
     ...
     * Sets connection_id
     *
     * @param string|null $connection_id Stable connection identifier — alias of accountId for this event variant.
     *
     * @return $this
     */
    ...
    /**
     * Gets disconnected_at
     *
     * @return \DateTime|null
     */
    public function getDisconnectedAt(): ?\DateTime
    {
        return $this->container['disconnected_at'];
    }

    /**
     * Sets disconnected_at
     *
     * @param \DateTime|null $disconnected_at disconnected_at
     *
     * @return $this
     */
    public function setDisconnectedAt(?\DateTime $disconnected_at): static
    {
        if (is_null($disconnected_at)) {
            throw new InvalidArgumentException('non-nullable disconnected_at cannot be null');
        }
        $this->container['disconnected_at'] = $disconnected_at;
