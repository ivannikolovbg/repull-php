...
class WebhookDelivery implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'WebhookDelivery';
     ...
     * Sets event_id
     *
     * @param string|null $event_id Stable across retries of the same logical event.
     *
     * @return $this
     */
     ...
     * @return $this
     */
    public function setSucceededAt(?\DateTime $succeeded_at): static
    {
