...
/**
 * RespondAirbnbReviewRequest Class Doc Comment
 *
 * @package  Repull
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class RespondAirbnbReviewRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'respond_airbnb_review_request';
    ...
    public function listInvalidProperties(): array
    {
        ...
        if ((mb_strlen($this->container['response']) > 1000)) {
            $invalidProperties[] = "invalid value for 'response', the character length must be smaller than or equal to 1000.";
        }
     ...
     * Sets response
     *
     * @param string $response Public response text. Capped at 1000 characters.
     *
     * @return $this
     */
    public function setResponse(string $response): static
    {
        ...
        if ((mb_strlen($response) > 1000)) {
            throw new InvalidArgumentException('invalid length for $response when calling RespondAirbnbReviewRequest., must be smaller than or equal to 1000.');
        }
