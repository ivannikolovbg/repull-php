...
/**
 * CreateStudioProjectRequest Class Doc Comment
 *
 * @package  Repull
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class CreateStudioProjectRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'createStudioProject_request';
     ...
     * Sets name
     *
     * @param string $name Human-readable project name. Used to derive the slug.
     *
     * @return $this
     */
     ...
     * Sets prompt
     *
     * @param string $prompt Initial prompt that seeds the project. Repull AI scaffolds the first generation from this.
     *
     * @return $this
     */
     ...
     * Sets template_id
     *
     * @param string|null $template_id Optional template to start from (e.g. `next-saas`). Omit to generate from prompt only.
     *
     * @return $this
     */
