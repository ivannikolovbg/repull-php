...
/**
 * StudioProject Class Doc Comment
 *
 ...
 */
class StudioProject implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'StudioProject';
     ...
     * Sets slug
     *
     * @param string|null $slug URL-safe slug (unique within your account). Used for the deployment subdomain.
     *
     * @return $this
     */
     ...
     * Sets name
     *
     * @param string|null $name Human-readable project name.
     *
     * @return $this
     */
     ...
     * Sets prompt
     *
     * @param string|null $prompt Initial prompt that seeded the project.
     *
     * @return $this
     */
     ...
     * Sets template_id
     *
     * @param string|null $template_id Template the project was scaffolded from, if any.
     *
     * @return $this
     */
     ...
     * Sets status
     *
     * @param string|null $status Current project lifecycle status.
     *
     * @return $this
     */
     ...
     * Sets customer_id
     *
     * @param int|null $customer_id Owning Repull account ID.
     *
     * @return $this
     */
     ...
     * Sets last_active_at
     *
     * @param \DateTime|null $last_active_at Updated whenever a file, generation, or deployment is touched.
     *
     * @return $this
     */
     ...
     * Sets deleted_at
     *
     * @param \DateTime|null $deleted_at Soft-delete timestamp. `null` for live projects.
     *
     * @return $this
     */
