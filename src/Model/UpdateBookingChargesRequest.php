...
/**
 * UpdateBookingChargesRequest Class Doc Comment
 *
 * @package  Repull
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class UpdateBookingChargesRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'update_booking_charges_request';
     ...
     * Sets charges
     *
     * @param array<string,mixed>[] $charges Full charge set to apply.
     *
     * @return $this
     */
