...
/**
 * AiOperationFailedEvent Class Doc Comment
 *
 * @package  Repull
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class AiOperationFailedEvent implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'AiOperationFailedEvent';
    ...
    protected static array $openAPITypes = [
        ...
        'created_at' => '\DateTime',
        'api_version' => 'string',
        'data' => '\Repull\Model\AiOperationFailedPayload'
    ];
     ...
     * Gets data
     *
     * @return \Repull\Model\AiOperationFailedPayload
     */
    public function getData(): \Repull\Model\AiOperationFailedPayload
    {
     ...
     * Sets data
     *
     * @param \Repull\Model\AiOperationFailedPayload $data data
     *
     * @return $this
     */
    public function setData(\Repull\Model\AiOperationFailedPayload $data): static
    {
        if (is_null($data)) {
