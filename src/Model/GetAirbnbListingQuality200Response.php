<?php
/**
 * GetAirbnbListingQuality200Response
 *
 * PHP version 8.1
 *
 * @package  Repull
...
/**
 * GetAirbnbListingQuality200Response Class Doc Comment
 *
 * @package  Repull
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class GetAirbnbListingQuality200Response implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'get_airbnb_listing_quality_200_response';
     ...
     * Sets data
     *
     * @param mixed|null $data Shape depends on `type`: an object `{ standards, issues }` for `all`/`standards`, or an array for `issues`/`stats`.
     *
     * @return $this
     */
