...
/**
 * AirbnbContentWriteResponse Class Doc Comment
 *
 ...
 */
class AirbnbContentWriteResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'AirbnbContentWriteResponse';
    ...
    protected static array $setters = [
        ...
        'locale' => 'setLocale',
        'written' => 'setWritten',
        'blocked_fields' => 'setBlockedFields',
        'message' => 'setMessage',
        'fix' => 'setFix',
        'result' => 'setResult'
    ];
    ...
    protected static array $getters = [
        ...
        'locale' => 'getLocale',
        'written' => 'getWritten',
        'blocked_fields' => 'getBlockedFields',
        'message' => 'getMessage',
        'fix' => 'getFix',
        'result' => 'getResult'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('blocked_fields', $data ?? [], null);
    ...
    public function listInvalidProperties(): array
    {
        ...
        if ($this->container['blocked_fields'] === null) {
            $invalidProperties[] = "'blocked_fields' can't be null";
        }
     ...
     *
     * @param string|null $airbnb_listing_id The Airbnb-side listing id the write went to.
     *
     * @return $this
     */
     ...
     * Sets locale
     *
     * @param string|null $locale Descriptions only — the locale written.
     *
     * @return $this
     */
     ...
     * Sets written
     *
     * @param string[] $written Fields that were applied.
     *
     * @return $this
     */
    public function setWritten(array $written): static
    {
        if (is_null($written)) {
    ...
    {
        return $this->container['blocked_fields'];
    }

    /**
     * Sets blocked_fields
     *
     * @param string[] $blocked_fields Fields you sent that Airbnb refused to change. Not retryable — the content is managed on Airbnb.
     *
     * @return $this
     */
    public function setBlockedFields(array $blocked_fields): static
    {
        if (is_null($blocked_fields)) {
            throw new InvalidArgumentException('non-nullable blocked_fields cannot be null');
        }
        $this->container['blocked_fields'] = $blocked_fields;
     ...
     * Sets message
     *
     * @param string|null $message Present only when `blockedFields` is non-empty: what was not applied.
     *
     * @return $this
     */
     ...
     * Sets fix
     *
     * @param string|null $fix Present only when `blockedFields` is non-empty: what to do about it.
     *
     * @return $this
     */
     ...
     * Sets result
     *
     * @param array<string,mixed>|null $result Airbnb's raw response.
     *
     * @return $this
     */
