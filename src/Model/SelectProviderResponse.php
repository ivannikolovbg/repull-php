...
/**
 * SelectProviderResponse Class Doc Comment
 *
 ...
 */
class SelectProviderResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'SelectProviderResponse';
    ...
    public const PATTERN_OAUTH = 'oauth';
    public const PATTERN_CREDENTIALS = 'credentials';
    public const PATTERN_ACTIVATION = 'activation';
    public const PATTERN_CLAIM = 'claim';
     ...
     * @return string[]
     */
    public static function getPatternAllowableValues()
    {
        return [
            self::PATTERN_OAUTH,
            self::PATTERN_CREDENTIALS,
            self::PATTERN_ACTIVATION,
            self::PATTERN_CLAIM,
        ];
    }
    ...
    public function listInvalidProperties(): array
    {
        ...
        $allowedValues = self::getPatternAllowableValues();
     ...
     * Sets next_url
     *
     * @param string|null $next_url Where to send the user next — OAuth consent, credentials form, activation checklist, or claim form.
     *
     * @return $this
     */
    public function setNextUrl(?string $next_url): static
    {
        if (is_null($next_url)) {
