<?php
/**
 * UsageQuotaWarningPayloadTopOperation
 *
 * PHP version 8.1
 *
 * @package  Repull
...
/**
 * UsageQuotaWarningPayloadTopOperation Class Doc Comment
 *
 ...
 */
class UsageQuotaWarningPayloadTopOperation implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'UsageQuotaWarningPayload_topOperation';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('share_percent', $data ?? [], null);
    }
    ...
    {
        return $this->container['share_percent'];
    }

    /**
     * Sets share_percent
     *
     * @param float|null $share_percent Share of the window's requests, 0-100.
     *
     * @return $this
     */
    public function setSharePercent(?float $share_percent): static
    {
        if (is_null($share_percent)) {
            throw new InvalidArgumentException('non-nullable share_percent cannot be null');
        }
        $this->container['share_percent'] = $share_percent;
