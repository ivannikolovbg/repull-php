...
/**
 * MapBookingRoomRequest Class Doc Comment
 *
 ...
 */
class MapBookingRoomRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'MapBookingRoomRequest';
    ...
    public function listInvalidProperties(): array
    {
        ...
        if ($this->container['room_booking_id'] === null) {
            $invalidProperties[] = "'room_booking_id' can't be null";
        }
     ...
     *
     * @param string $room_booking_id Booking.com's own room id. Discover it via `GET /v1/channels/booking/properties/{id}/rooms` (`rooms[].roomId`). A number is also accepted.
     *
     * @return $this
     */
    public function setRoomBookingId(string $room_booking_id): static
    {
        if (is_null($room_booking_id)) {
            throw new InvalidArgumentException('non-nullable room_booking_id cannot be null');
        }
     ...
     * Sets listing_id
     *
     * @param int|null $listing_id Canonical Repull listing id to link the room to. Must belong to your workspace and be active. `null` unmaps the room and removes its channel link. The field is required — omitting it is a 422, not an unmap.
     *
     * @return $this
     */
     ...
     * Sets hotel_id
     *
     * @param string|null $hotel_id Optional. When present, must be the Booking.com property the room belongs to — guards against mapping a room of the wrong property when looping over several.
     *
     * @return $this
     */
     ...
     * Sets sync_enabled
     *
     * @param bool|null $sync_enabled Whether the resulting channel link has sync enabled.
     *
     * @return $this
     */
