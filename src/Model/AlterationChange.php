...
/**
 * AlterationChange Class Doc Comment
 *
 ...
 */
class AlterationChange implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'AlterationChange';
     ...
     * Sets from
     *
     * @param mixed|null $from Prior value (string date, integer count, or decimal price string).
     *
     * @return $this
     */
    public function setFrom(mixed $from): static
    {
        if (is_null($from)) {
     ...
     * Sets to
     *
     * @param mixed|null $to Proposed value (string date, integer count, or decimal price string).
     *
     * @return $this
     */
    public function setTo(mixed $to): static
    {
        if (is_null($to)) {
