<?php
/**
 * GetUsageTier200ResponseRemaining
 *
 * PHP version 8.1
 *
 * @package  Repull
...
/**
 * GetUsageTier200ResponseRemaining Class Doc Comment
 *
 * @package  Repull
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class GetUsageTier200ResponseRemaining implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'get_usage_tier_200_response_remaining';
     ...
     * Sets monthly
     *
     * @param int|null $monthly monthly
     *
     * @return $this
     */
     ...
     * @return int|null
     */
    public function getDailyAi(): ?int
    {
        return $this->container['daily_ai'];
    }

    /**
     * Sets daily_ai
     *
     * @param int|null $daily_ai daily_ai
     *
     * @return $this
     */
    public function setDailyAi(?int $daily_ai): static
    {
        if (is_null($daily_ai)) {
            array_push($this->openAPINullablesSetToNull, 'daily_ai');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('daily_ai', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['daily_ai'] = $daily_ai;
