...
/**
 * PublishSectionError Class Doc Comment
 *
 ...
 */
class PublishSectionError implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'PublishSectionError';
    ...
    public const SECTION_DETAILS = 'details';
    public const SECTION_DESCRIPTION = 'description';
    public const SECTION_AMENITIES = 'amenities';
    public const SECTION_ROOMS = 'rooms';
    public const SECTION_POLICIES = 'policies';
    public const SECTION_PHOTOS = 'photos';
    public const SECTION_PRICING = 'pricing';
    public const SECTION_CHECKOUT_TASKS = 'checkout_tasks';
     ...
     * @return string[]
     */
    public static function getSectionAllowableValues()
    {
        return [
            self::SECTION_DETAILS,
            self::SECTION_DESCRIPTION,
            self::SECTION_AMENITIES,
            self::SECTION_ROOMS,
            self::SECTION_POLICIES,
            self::SECTION_PHOTOS,
            self::SECTION_PRICING,
            self::SECTION_CHECKOUT_TASKS,
        ];
    }
    ...
    public function listInvalidProperties(): array
    {
        ...
        $allowedValues = self::getSectionAllowableValues();
     ...
     * Sets section
     *
     * @param string $section Which part of the listing this failure is about.
     *
     * @return $this
     */
     ...
     * Sets message
     *
     * @param string $message Airbnb's own reason, verbatim, or ours when we refused to send an empty section.
     *
     * @return $this
     */
     ...
     * Sets code
     *
     * @param string $code `locked` — Airbnb refuses to change these fields on this listing; retrying cannot succeed and `lockedFields` names them. `no_content` — there was nothing canonical to send; write the content, then publish again. `rejected` — Airbnb refused the section as sent; fix the content and publish again.
     *
     * @return $this
     */
     ...
     * Sets locked_fields
     *
     * @param string[]|null $locked_fields For `code: locked` — the fields Airbnb dropped.
     *
     * @return $this
     */
