...
/**
 * V1ConnectProviderPostRequest Class Doc Comment
 *
 ...
 */
class V1ConnectProviderPostRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = '_v1_connect__provider__post_request';
