...
/**
 * ReviewCategory Class Doc Comment
 *
 ...
 */
class ReviewCategory implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'ReviewCategory';
     ...
     * Sets rating
     *
     * @param float|null $rating Per-category rating on the platform's scale (typically 1..5).
     *
     * @return $this
     */
