...
/**
 * ReservationUpdatedEvent Class Doc Comment
 *
 * @package  Repull
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ReservationUpdatedEvent implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'ReservationUpdatedEvent';
    ...
    protected static array $openAPITypes = [
        ...
        'created_at' => '\DateTime',
        'api_version' => 'string',
        'data' => '\Repull\Model\ReservationUpdatedPayload'
    ];
     ...
     * Gets data
     *
     * @return \Repull\Model\ReservationUpdatedPayload
     */
    public function getData(): \Repull\Model\ReservationUpdatedPayload
    {
     ...
     * Sets data
     *
     * @param \Repull\Model\ReservationUpdatedPayload $data data
     *
     * @return $this
     */
    public function setData(\Repull\Model\ReservationUpdatedPayload $data): static
    {
        if (is_null($data)) {
