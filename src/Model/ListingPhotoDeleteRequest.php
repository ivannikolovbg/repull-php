...
/**
 * ListingPhotoDeleteRequest Class Doc Comment
 *
 * @package  Repull
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ListingPhotoDeleteRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'ListingPhotoDeleteRequest';
     ...
     * Sets path
     *
     * @param string $path Storage path of the photo to delete, as returned by `GET /v1/listings/{id}/photos` or the `upload-url` response.
     *
     * @return $this
     */
