 ...
 */
class GuestFlag implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'GuestFlag';
     ...
     * Sets type
     *
     * @param string|null $type Severity / category (e.g. `info`, `warning`, `block`).
     *
     * @return $this
     */
     ...
     * Sets note
     *
     * @param string|null $note Reason text when present.
     *
     * @return $this
     */
