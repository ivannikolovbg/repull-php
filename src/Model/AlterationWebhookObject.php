...
/**
 * AlterationWebhookObject Class Doc Comment
 *
 ...
 */
class AlterationWebhookObject implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'AlterationWebhookObject';
     ...
     * @return string[]
     */
    public static function getInitiatorAllowableValues()
    {
        return [
            self::INITIATOR_GUEST,
            self::INITIATOR_HOST,
        ];
    }
    ...
    public function listInvalidProperties(): array
    {
        ...
        $allowedValues = self::getInitiatorAllowableValues();
        if (!is_null($this->container['initiator']) && !in_array($this->container['initiator'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'initiator', must be one of '%s'",
                $this->container['initiator'],
                implode("', '", $allowedValues)
            );
        }
     ...
     * Sets id
     *
     * @param int $id Repull-internal alteration id (`reservation_alterations.id`).
     *
     * @return $this
     */
     ...
     * Sets alteration_id
     *
     * @param string|null $alteration_id Provider-side alteration/resolution id.
     *
     * @return $this
     */
     ...
     * Sets channel
     *
     * @param string $channel Source channel. Currently always `airbnb`.
     *
     * @return $this
     */
     ...
     * Sets reservation_id
     *
     * @param int $reservation_id Repull reservation id the alteration targets. Pass to `GET /v1/reservations/{id}`.
     *
     * @return $this
     */
     ...
     * Sets status
     *
     * @param string $status Alteration lifecycle status.
     *
     * @return $this
     */
     ...
     * Sets initiator
     *
     * @param string|null $initiator Who requested the alteration.
     *
     * @return $this
     */
