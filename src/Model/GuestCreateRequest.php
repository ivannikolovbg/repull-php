...
/**
 * GuestCreateRequest Class Doc Comment
 *
 * @package  Repull
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class GuestCreateRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'GuestCreateRequest';
     ...
     * Sets phone
     *
     * @param string|null $phone E.164 preferred. Stored normalised.
     *
     * @return $this
     */
    ...
    public function setCurrency(?string $currency): static
    {
        ...
        if ((mb_strlen($currency) > 3)) {
            throw new InvalidArgumentException('invalid length for $currency when calling GuestCreateRequest., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($currency) < 3)) {
            throw new InvalidArgumentException('invalid length for $currency when calling GuestCreateRequest., must be bigger than or equal to 3.');
        }
    ...
    /**
     * Gets is_business_traveler
     *
     * @return bool|null
     */
    public function getIsBusinessTraveler(): ?bool
    {
        return $this->container['is_business_traveler'];
    }

    /**
     * Sets is_business_traveler
     *
     * @param bool|null $is_business_traveler is_business_traveler
     *
     * @return $this
     */
    public function setIsBusinessTraveler(?bool $is_business_traveler): static
    {
        if (is_null($is_business_traveler)) {
