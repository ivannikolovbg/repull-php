<?php
/**
 * GetUsageSummary200ResponseBreakdownInner
 *
 * PHP version 8.1
 *
 * @package  Repull
...
/**
 * GetUsageSummary200ResponseBreakdownInner Class Doc Comment
 *
 * @package  Repull
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class GetUsageSummary200ResponseBreakdownInner implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'get_usage_summary_200_response_breakdown_inner';
     ...
     * @return $this
     */
    public function setErrorCount(?int $error_count): static
    {
     ...
     * @return $this
     */
    public function setErrorRate(?float $error_rate): static
    {
     ...
     * Sets avg_latency_ms
     *
     * @param int|null $avg_latency_ms avg_latency_ms
     *
     * @return $this
     */
    public function setAvgLatencyMs(?int $avg_latency_ms): static
    {
