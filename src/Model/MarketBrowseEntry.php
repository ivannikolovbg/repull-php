...
/**
 * MarketBrowseEntry Class Doc Comment
 *
 ...
 */
class MarketBrowseEntry implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'MarketBrowseEntry';
     ...
     * Sets currency
     *
     * @param string|null $currency ISO 4217 currency derived from the country code.
     *
     * @return $this
     */
