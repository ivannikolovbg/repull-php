...
/**
 * ReservationCreateResponse Class Doc Comment
 *
 * @package  Repull
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ReservationCreateResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'ReservationCreateResponse';
     ...
     * Sets total_price
     *
     * @param float|null $total_price The price the pricing engine derived for the stay. Reservations created through this endpoint are NOT priced from the request — see the operation description.
     *
     * @return $this
     */
