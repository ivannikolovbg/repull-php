...
/**
 * AccountCreatedEvent Class Doc Comment
 *
 * @package  Repull
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class AccountCreatedEvent implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'AccountCreatedEvent';
    ...
    protected static array $openAPITypes = [
        ...
        'created_at' => '\DateTime',
        'api_version' => 'string',
        'data' => '\Repull\Model\AccountCreatedPayload'
    ];
     ...
     * Gets data
     *
     * @return \Repull\Model\AccountCreatedPayload
     */
    public function getData(): \Repull\Model\AccountCreatedPayload
    {
     ...
     * Sets data
     *
     * @param \Repull\Model\AccountCreatedPayload $data data
     *
     * @return $this
     */
    public function setData(\Repull\Model\AccountCreatedPayload $data): static
    {
        if (is_null($data)) {
