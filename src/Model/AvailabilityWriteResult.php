...
/**
 * AvailabilityWriteResult Class Doc Comment
 *
 * @package  Repull
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class AvailabilityWriteResult implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'AvailabilityWriteResult';
    ...
    protected static array $openAPITypes = [
        'listing_ids' => 'string[]',
        'dates' => 'int',
        'synced' => '\Repull\Model\AvailabilityWriteResultSynced',
        'warning' => 'string'
    ];
     ...
     * Sets listing_ids
     *
     * @param string[]|null $listing_ids listing_ids
     *
     * @return $this
     */
     ...
     * Sets dates
     *
     * @param int|null $dates How many dates were written.
     *
     * @return $this
     */
    public function setDates(?int $dates): static
    {
        if (is_null($dates)) {
     ...
     * Gets synced
     *
     * @return \Repull\Model\AvailabilityWriteResultSynced|null
     */
    public function getSynced(): ?\Repull\Model\AvailabilityWriteResultSynced
    {
     ...
     * Sets synced
     *
     * @param \Repull\Model\AvailabilityWriteResultSynced|null $synced synced
     *
     * @return $this
     */
    public function setSynced(?\Repull\Model\AvailabilityWriteResultSynced $synced): static
    {
        if (is_null($synced)) {
     ...
     * Sets warning
     *
     * @param string|null $warning Present only when one or more channel pushes failed.
     *
     * @return $this
     */
