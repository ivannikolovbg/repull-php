...
/**
 * AirbnbThread Class Doc Comment
 *
 ...
 */
class AirbnbThread implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'AirbnbThread';
