<?php
/**
 * ReorderAirbnbListingPhotos200ResponseData
 *
 * PHP version 8.1
 *
 * @package  Repull
...
/**
 * ReorderAirbnbListingPhotos200ResponseData Class Doc Comment
 *
 * @package  Repull
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ReorderAirbnbListingPhotos200ResponseData implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'reorder_airbnb_listing_photos_200_response_data';
     ...
     * Sets order
     *
     * @param \Repull\Model\AirbnbPhotoPosition[]|null $order The resulting tour order, including photos you did not name.
     *
     * @return $this
     */
     ...
     * Sets applied
     *
     * @param \Repull\Model\AirbnbPhotoPosition[]|null $applied The photos this call actually moved.
     *
     * @return $this
     */
     ...
     * Sets unchanged
     *
     * @param int|null $unchanged Photos that were already in the right position.
     *
     * @return $this
     */
    public function setUnchanged(?int $unchanged): static
    {
