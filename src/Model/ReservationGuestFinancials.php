...
/**
 * ReservationGuestFinancials Class Doc Comment
 *
 ...
 */
class ReservationGuestFinancials implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'ReservationGuestFinancials';
    ...
    protected static array $openAPITypes = [
        'total_price' => 'float',
        'fees' => '\Repull\Model\ReservationMoneyLine[]',
     ...
     * Sets total_price
     *
     * @param float|null $total_price Stay total the guest paid, in `currency`. Taken from the stored breakdown; falls back to the reservation total when the breakdown carries no total of its own.
     *
     * @return $this
     */
     ...
     * Sets fees
     *
     * @param \Repull\Model\ReservationMoneyLine[]|null $fees Every fee line the guest was charged — cleaning, extra guest, pass-through host fees, platform guest service fee, channel add-ons. Deduplicated: channels that report a fee both as an array line and as a scalar (e.g. `cleaning`) yield ONE line.
     *
     * @return $this
     */
     ...
     * Sets taxes
     *
     * @param \Repull\Model\ReservationMoneyLine[]|null $taxes Every tax line the guest was charged. Same collection as `financials.host.taxes`.
     *
     * @return $this
     */
