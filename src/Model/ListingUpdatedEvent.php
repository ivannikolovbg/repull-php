...
/**
 * ListingUpdatedEvent Class Doc Comment
 *
 * @package  Repull
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ListingUpdatedEvent implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'ListingUpdatedEvent';
    ...
    protected static array $openAPITypes = [
        ...
        'created_at' => '\DateTime',
        'api_version' => 'string',
        'data' => '\Repull\Model\ListingUpdatedPayload'
    ];
     ...
     * Gets data
     *
     * @return \Repull\Model\ListingUpdatedPayload
     */
    public function getData(): \Repull\Model\ListingUpdatedPayload
    {
     ...
     * Sets data
     *
     * @param \Repull\Model\ListingUpdatedPayload $data data
     *
     * @return $this
     */
    public function setData(\Repull\Model\ListingUpdatedPayload $data): static
    {
        if (is_null($data)) {
