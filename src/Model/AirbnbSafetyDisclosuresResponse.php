...
/**
 * AirbnbSafetyDisclosuresResponse Class Doc Comment
 *
 * @package  Repull
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class AirbnbSafetyDisclosuresResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'AirbnbSafetyDisclosuresResponse';
     ...
     * Sets disclosures
     *
     * @param \Repull\Model\AirbnbSafetyDisclosure[]|null $disclosures Every supported disclosure type, including the ones this listing has not declared (`value: false`), so \"does this property have cameras?\" has an answer rather than a missing key. Types Airbnb returns that are not in the documented set are passed through, never dropped.
     *
     * @return $this
     */
     ...
     * Sets declared
     *
     * @param string[]|null $declared Just the types that are true of this property.
     *
     * @return $this
     */
    public function setDeclared(?array $declared): static
    {
        if (is_null($declared)) {
