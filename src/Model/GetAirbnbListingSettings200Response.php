<?php
/**
 * GetAirbnbListingSettings200Response
 *
 * PHP version 8.1
 *
 * @package  Repull
...
/**
 * GetAirbnbListingSettings200Response Class Doc Comment
 *
 * @package  Repull
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class GetAirbnbListingSettings200Response implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'get_airbnb_listing_settings_200_response';
     ...
     * Sets data
     *
     * @param mixed|null $data Shape depends on `type`: `{ hosts, locales }` for `all`, or an array for `hosts`/`permits`/`locales`.
     *
     * @return $this
     */
