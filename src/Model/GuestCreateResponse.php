...
/**
 * GuestCreateResponse Class Doc Comment
 *
 * @package  Repull
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class GuestCreateResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'GuestCreateResponse';
     ...
     * Sets id
     *
     * @param int|null $id Pass to `GET /v1/guests/{id}` for the full profile.
     *
     * @return $this
     */
     ...
     * Sets created
     *
     * @param bool|null $created `true` when a new guest was written, `false` when an existing guest matched on email/phone plus name. Read this rather than assuming a 2xx means a new record.
     *
     * @return $this
     */
