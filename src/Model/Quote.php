...
class Quote implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    protected static array $openAPITypes = [
        ...
        'pricing' => '\Repull\Model\QuotePricing'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('available_units', $data ?? [], null);
     ...
     * Sets available
     *
     * @param bool|null $available False when the listing is unavailable for the range or outside its min/max stay. That is an answer, not an error.
     *
     * @return $this
     */
     ...
     * Sets reason
     *
     * @param string|null $reason Why it is unavailable. Present only when `available` is false.
     *
     * @return $this
     */
     ...
     * @return float|null
     */
    public function getAvailableUnits(): ?float
    {
     ...
     *
     * @param float|null $available_units available_units
     *
     * @return $this
     */
    public function setAvailableUnits(?float $available_units): static
    {
        if (is_null($available_units)) {
            array_push($this->openAPINullablesSetToNull, 'available_units');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('available_units', $nullablesSetToNull);
            if ($index !== FALSE) {
     ...
     * Gets pricing
     *
     * @return \Repull\Model\QuotePricing|null
     */
    public function getPricing(): ?\Repull\Model\QuotePricing
    {
     ...
     * Sets pricing
     *
     * @param \Repull\Model\QuotePricing|null $pricing pricing
     *
     * @return $this
     */
    public function setPricing(?\Repull\Model\QuotePricing $pricing): static
    {
        if (is_null($pricing)) {
