 ...
 */
class BookingPricingRateUpdateDateRange implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'BookingPricingRateUpdate_dateRange';
