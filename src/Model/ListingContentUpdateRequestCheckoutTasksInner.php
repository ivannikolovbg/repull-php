...
/**
 * ListingContentUpdateRequestCheckoutTasksInner Class Doc Comment
 *
 * @package  Repull
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ListingContentUpdateRequestCheckoutTasksInner implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'ListingContentUpdateRequest_checkoutTasks_inner';
    ...
    public const TASK_TYPE_RETURN_KEYS = 'return_keys';
    public const TASK_TYPE_TURN_THINGS_OFF = 'turn_things_off';
    public const TASK_TYPE_THROW_TRASH = 'throw_trash';
    public const TASK_TYPE_LOCK_UP = 'lock_up';
    public const TASK_TYPE_GATHER_TOWELS = 'gather_towels';
    public const TASK_TYPE_ADDITIONAL_REQUESTS = 'additional_requests';
     ...
     * @return string[]
     */
    public static function getTaskTypeAllowableValues()
    {
        return [
            self::TASK_TYPE_RETURN_KEYS,
            self::TASK_TYPE_TURN_THINGS_OFF,
            self::TASK_TYPE_THROW_TRASH,
            self::TASK_TYPE_LOCK_UP,
            self::TASK_TYPE_GATHER_TOWELS,
            self::TASK_TYPE_ADDITIONAL_REQUESTS,
        ];
    }
    ...
    public function listInvalidProperties(): array
    {
        ...
        $allowedValues = self::getTaskTypeAllowableValues();
     ...
     * Sets task_type
     *
     * @param string $task_type Any casing is accepted; stored lowercase.
     *
     * @return $this
     */
     ...
     * Sets instructions
     *
     * @param string|null $instructions Detail shown to the guest with the task, e.g. \"Leave the keys on the kitchen counter\".
     *
     * @return $this
     */
