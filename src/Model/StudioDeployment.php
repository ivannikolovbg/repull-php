...
/**
 * StudioDeployment Class Doc Comment
 *
 ...
 */
class StudioDeployment implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'StudioDeployment';
     ...
     * @return $this
     */
    public function setProjectId(?string $project_id): static
    {
     ...
     * Sets subdomain
     *
     * @param string|null $subdomain Subdomain assigned to this deployment (e.g. `my-app-a1b2c3`).
     *
     * @return $this
     */
     ...
     * Sets status
     *
     * @param string|null $status Current deployment lifecycle status.
     *
     * @return $this
     */
     ...
     * Sets url
     *
     * @param string|null $url Fully-qualified URL where the deployment is reachable when `status` is `live`.
     *
     * @return $this
     */
     ...
     * Sets suspended_at
     *
     * @param \DateTime|null $suspended_at Set when the deployment is paused via `/suspend`.
     *
     * @return $this
     */
