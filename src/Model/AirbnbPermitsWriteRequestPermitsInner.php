<?php
/**
 * AirbnbPermitsWriteRequestPermitsInner
 *
 * PHP version 8.1
 *
 * @package  Repull
...
/**
 * AirbnbPermitsWriteRequestPermitsInner Class Doc Comment
 *
 * @package  Repull
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class AirbnbPermitsWriteRequestPermitsInner implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'AirbnbPermitsWriteRequest_permits_inner';
    ...
    public function listInvalidProperties(): array
    {
        ...
        if ($this->container['regulatory_body'] === null) {
            $invalidProperties[] = "'regulatory_body' can't be null";
        }
    ...
    public function setRegulatoryBody(string $regulatory_body): static
    {
        if (is_null($regulatory_body)) {
            throw new InvalidArgumentException('non-nullable regulatory_body cannot be null');
        }
    ...
    public function setRegulationType(string $regulation_type): static
    {
        if (is_null($regulation_type)) {
            throw new InvalidArgumentException('non-nullable regulation_type cannot be null');
        }
    ...
    public function setAnswers(array $answers): static
    {
        ...
        if ((count($answers) < 1)) {
            throw new InvalidArgumentException('invalid length for $answers when calling AirbnbPermitsWriteRequestPermitsInner., number of items must be greater than or equal to 1.');
        }
