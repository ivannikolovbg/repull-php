...
/**
 * ListingPhotoUploadUrlRequest Class Doc Comment
 *
 * @package  Repull
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ListingPhotoUploadUrlRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'ListingPhotoUploadUrlRequest';
     ...
     * Sets file_name
     *
     * @param string $file_name Original file name, e.g. \"living-room.jpg\".
     *
     * @return $this
     */
     ...
     * Sets file_type
     *
     * @param string $file_type Image MIME type. Must start with \"image/\".
     *
     * @return $this
     */
     ...
     * Sets file_size
     *
     * @param int|null $file_size File size in bytes, when known. Must be positive if provided.
     *
     * @return $this
     */
