...
/**
 * ListingGenerateContentRequest Class Doc Comment
 *
 * @package  Repull
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ListingGenerateContentRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'ListingGenerateContentRequest';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('style', $data ?? [], 'warm');
        $this->setIfExists('persist', $data ?? [], true);
    }
    ...
    public function listInvalidProperties(): array
    {
        ...
        if (!is_null($this->container['photos']) && (count($this->container['photos']) > 8)) {
            $invalidProperties[] = "invalid value for 'photos', number of items must be less than or equal to 8.";
        }

        $allowedValues = self::getStyleAllowableValues();
    ...
    public function setPhotos(?array $photos): static
    {
        ...
        if ((count($photos) > 8)) {
            throw new InvalidArgumentException('invalid value for $photos when calling ListingGenerateContentRequest., number of items must be less than or equal to 8.');
        }
     ...
     * Sets persist
     *
     * @param bool|null $persist Save the generated content to the listing (so subsequent publishes pick it up).
     *
     * @return $this
     */
