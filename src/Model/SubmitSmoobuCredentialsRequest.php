<?php
/**
 * SubmitSmoobuCredentialsRequest
 *
 * PHP version 8.1
 *
 * @package  Repull
...
/**
 * SubmitSmoobuCredentialsRequest Class Doc Comment
 *
 * @package  Repull
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class SubmitSmoobuCredentialsRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'submitSmoobuCredentials_request';
     ...
     * Sets session_id
     *
     * @param string|null $session_id Connect session id from `POST /v1/connect/smoobu`.
     *
     * @return $this
     */
