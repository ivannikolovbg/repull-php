...
/**
 * MarketsOverviewResponseBrowse Class Doc Comment
 *
 ...
 */
class MarketsOverviewResponseBrowse implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'MarketsOverviewResponse_browse';
    ...
    protected static array $openAPITypes = [
        'featured' => '\Repull\Model\MarketBrowseFeatured[]',
        'categories' => '\Repull\Model\MarketBrowseCategory[]',
        'total_available' => 'int'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('total_available', $data ?? [], null);
    }
     ...
     * Gets featured
     *
     * @return \Repull\Model\MarketBrowseFeatured[]|null
     */
     ...
     * Sets featured
     *
     * @param \Repull\Model\MarketBrowseFeatured[]|null $featured Top ~50 markets by listing volume the customer doesn't already operate in.
     *
     * @return $this
     */
     ...
     * Gets categories
     *
     * @return \Repull\Model\MarketBrowseCategory[]|null
     */
     ...
     * Sets categories
     *
     * @param \Repull\Model\MarketBrowseCategory[]|null $categories Top 50 countries by tracked-city count.
     *
     * @return $this
     */
     ...
     *
     * @param int|null $total_available Total Atlas-tracked cities in the catalog.
     *
     * @return $this
     */
    public function setTotalAvailable(?int $total_available): static
    {
        if (is_null($total_available)) {
            throw new InvalidArgumentException('non-nullable total_available cannot be null');
        }
