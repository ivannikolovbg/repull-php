...
/**
 * ReservationMoneyLine Class Doc Comment
 *
 ...
 */
class ReservationMoneyLine implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'ReservationMoneyLine';
     ...
     * Sets name
     *
     * @param string|null $name Label as the channel reported it.
     *
     * @return $this
     */
     ...
     * Sets amount
     *
     * @param float $amount Amount in the reservation `currency`.
     *
     * @return $this
     */
     ...
     * Sets description
     *
     * @param string|null $description Longer channel-supplied description. Only present when it differs from `name`.
     *
     * @return $this
     */
     ...
     * Sets quantity
     *
     * @param float|null $quantity Units billed, when the channel reports a quantity (Booking.com add-ons).
     *
     * @return $this
     */
     ...
     * Sets vat
     *
     * @param float|null $vat VAT charged on top of this line, when the channel splits it out separately.
     *
     * @return $this
     */
