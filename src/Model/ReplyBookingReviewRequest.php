...
/**
 * ReplyBookingReviewRequest Class Doc Comment
 *
 * @package  Repull
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ReplyBookingReviewRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'reply_booking_review_request';
     ...
     * Sets property_id
     *
     * @param string $property_id Booking.com hotel/property id.
     *
     * @return $this
     */
     ...
     * Sets review_id
     *
     * @param string $review_id Booking.com review id (from `GET /v1/channels/booking/reviews`).
     *
     * @return $this
     */
     ...
     * Sets response
     *
     * @param string $response Public host reply text.
     *
     * @return $this
     */
