...
/**
 * BookingVerifyHotelRequest Class Doc Comment
 *
 ...
 */
class BookingVerifyHotelRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'BookingVerifyHotelRequest';
     ...
     * Sets session_id
     *
     * @param string $session_id The Connect session ID returned by `createConnectSession`. Acts as the capability token — no API key required.
     *
     * @return $this
     */
     ...
     * Sets hotel_id
     *
     * @param string $hotel_id Booking.com hotel ID the customer pasted. 6+ digits.
     *
     * @return $this
     */
