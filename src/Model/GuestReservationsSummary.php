...
/**
 * GuestReservationsSummary Class Doc Comment
 *
 ...
 */
class GuestReservationsSummary implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'GuestReservationsSummary';
     ...
     * Sets future
     *
     * @param int|null $future future
     *
     * @return $this
     */
    public function setFuture(?int $future): static
    {
        if (is_null($future)) {
     ...
     * Sets past
     *
     * @param int|null $past past
     *
     * @return $this
     */
    public function setPast(?int $past): static
    {
        if (is_null($past)) {
     ...
     * Sets cancelled
     *
     * @param int|null $cancelled cancelled
     *
     * @return $this
     */
