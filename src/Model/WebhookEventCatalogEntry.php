...
/**
 * WebhookEventCatalogEntry Class Doc Comment
 *
 * @package  Repull
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class WebhookEventCatalogEntry implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'WebhookEventCatalogEntry';
    ...
    protected static array $openAPITypes = [
        'type' => '\Repull\Model\WebhookEventType',
        'domain' => 'string',
        'title' => 'string',
        'description' => 'string',
    ...
    public const DOMAIN_RESERVATIONS = 'reservations';
    public const DOMAIN_LISTINGS = 'listings';
    public const DOMAIN_CALENDAR = 'calendar';
    public const DOMAIN_ACCOUNTS = 'accounts';
    public const DOMAIN_REVIEWS = 'reviews';
    public const DOMAIN_AI = 'ai';
    public const DOMAIN_PAYMENTS = 'payments';
    public const DOMAIN_SYSTEM = 'system';
     ...
     * @return string[]
     */
    public static function getDomainAllowableValues()
    {
        return [
            self::DOMAIN_RESERVATIONS,
            self::DOMAIN_LISTINGS,
            self::DOMAIN_CALENDAR,
            self::DOMAIN_ACCOUNTS,
            self::DOMAIN_REVIEWS,
            self::DOMAIN_AI,
            self::DOMAIN_PAYMENTS,
            self::DOMAIN_SYSTEM,
        ];
    }
     ...
     */
    public function getType(): ?\Repull\Model\WebhookEventType
    {
     ...
     * Sets type
     *
     * @param \Repull\Model\WebhookEventType|null $type type
     *
     * @return $this
     */
    public function setType(?\Repull\Model\WebhookEventType $type): static
    {
        if (is_null($type)) {
     ...
     * Sets sample_payload
     *
     * @param object|null $sample_payload Realistic example of the `data` payload an event of this `type` will deliver. Shape matches the matching variant in the `WebhookEvent` discriminated union.
     *
     * @return $this
     */
