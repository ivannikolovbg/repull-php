...
/**
 * BookingConversation Class Doc Comment
 *
 ...
 */
class BookingConversation implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'BookingConversation';
