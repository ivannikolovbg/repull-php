...
/**
 * GetUsageTier200ResponseUsed Class Doc Comment
 *
 * @package  Repull
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class GetUsageTier200ResponseUsed implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'get_usage_tier_200_response_used';
    ...
    {
        if (is_null($daily_ai)) {
            throw new InvalidArgumentException('non-nullable daily_ai cannot be null');
        }
    ...
    public function setDynamicPricingListings(?int $dynamic_pricing_listings): static
    {
        if (is_null($dynamic_pricing_listings)) {
            throw new InvalidArgumentException('non-nullable dynamic_pricing_listings cannot be null');
        }
