...
class QuotesApi
{
     ...
     * Price a stay
     *
     * @param  int $property_id Repull property id — discover via &#x60;GET /v1/properties&#x60;. (required)
     * @param  \DateTime $check_in check_in (required)
     * @param  \DateTime $check_out check_out (required)
     * @param  int|null $guests guests (optional, default to 1)
     * @param  int|null $pets pets (optional, default to 0)
     * @param  int|null $website_id Which booking site to price against. Defaults to the workspace&#39;s only site. (optional)
     ...
     *
     * @param  int $property_id Repull property id — discover via &#x60;GET /v1/properties&#x60;. (required)
     * @param  \DateTime $check_in (required)
     * @param  \DateTime $check_out (required)
     * @param  int|null $guests (optional, default to 1)
     * @param  int|null $pets (optional, default to 0)
     * @param  int|null $website_id Which booking site to price against. Defaults to the workspace&#39;s only site. (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getQuote'] to see the possible values for this operation
     *
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array of \Repull\Model\Quote|\Repull\Model\Error|\Repull\Model\Error|\Repull\Model\Error|\Repull\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $request = $this->getQuoteRequest($property_id, $check_in, $check_out, $guests, $pets, $website_id, $contentType);
    ...
    {
        return $this->getQuoteAsyncWithHttpInfo($property_id, $check_in, $check_out, $guests, $pets, $website_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return PromiseInterface
     */
    public function getQuoteAsyncWithHttpInfo(
        int $property_id,
        \DateTime $check_in,
        \DateTime $check_out,
        ?int $guests = 1,
    ...
    ): Request
    {
        ...
        if ($property_id === null || (is_array($property_id) && count($property_id) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $property_id when calling getQuote'
            );
        }
        ...
        if ($check_in === null || (is_array($check_in) && count($check_in) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $check_in when calling getQuote'
            );
        }
        ...
        if ($check_out === null || (is_array($check_out) && count($check_out) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $check_out when calling getQuote'
            );
        }
