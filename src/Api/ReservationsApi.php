...
class ReservationsApi
{
    ...
    {
        list($response) = $this->getReservationWithHttpInfo($id, $contentType);
        return $response;
    }
    ...
    {
        $request = $this->getReservationRequest($id, $contentType);
    ...
    {
        return $this->getReservationAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    {
        list($response) = $this->listReservationsWithHttpInfo($limit, $cursor, $offset, $platform, $status, $listing_id, $check_in_after, $check_in_before, $check_in_from, $check_in_to, $contentType);
        return $response;
    }
    ...
    {
        $request = $this->listReservationsRequest($limit, $cursor, $offset, $platform, $status, $listing_id, $check_in_after, $check_in_before, $check_in_from, $check_in_to, $contentType);
    ...
    {
        return $this->listReservationsAsyncWithHttpInfo($limit, $cursor, $offset, $platform, $status, $listing_id, $check_in_after, $check_in_before, $check_in_from, $check_in_to, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
