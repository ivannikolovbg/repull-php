...
class AvailabilityApi
{
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array of \Repull\Model\AvailabilityWriteResult|\Repull\Model\Error|\Repull\Model\Error|\Repull\Model\Error|\Repull\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     *
     * @param  int $property_id Repull property id (equal to &#x60;listings.id&#x60;; the same integer used as &#x60;propertyId&#x60; on availability and &#x60;listingId&#x60; on reservations). (required)
     * @param  \DateTime $from Start of the window (inclusive), ISO &#x60;YYYY-MM-DD&#x60;. Required — missing/malformed returns 422. &#x60;startDate&#x60; is accepted as an alias. (required)
     * @param  \DateTime $to End of the window (inclusive), ISO &#x60;YYYY-MM-DD&#x60;. Required — missing/malformed returns 422. &#x60;endDate&#x60; is accepted as an alias. (required)
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return \Repull\Model\PropertyAvailability|\Repull\Model\Error
     */
    ...
    ): \Repull\Model\PropertyAvailability|\Repull\Model\Error
    {
        list($response) = $this->getAvailabilityWithHttpInfo($property_id, $from, $to, $contentType);
        return $response;
    }
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array of \Repull\Model\PropertyAvailability|\Repull\Model\Error|\Repull\Model\Error|\Repull\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $request = $this->getAvailabilityRequest($property_id, $from, $to, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\Repull\Model\PropertyAvailability',
                        $request,
                        $response,
                    );
                case 403:
    ...
    {
        return $this->getAvailabilityAsyncWithHttpInfo($property_id, $from, $to, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    {
        $returnType = '\Repull\Model\PropertyAvailability';
        $request = $this->getAvailabilityRequest($property_id, $from, $to, $contentType);
    ...
    ): Request
    {
        ...
        if ($from === null || (is_array($from) && count($from) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $from when calling getAvailability'
            );
        }
        ...
        if ($to === null || (is_array($to) && count($to) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $to when calling getAvailability'
            );
        }
