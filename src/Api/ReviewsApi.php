...
class ReviewsApi
{
     ...
     * @return \Repull\Model\Review|\Repull\Model\Error
     */
    public function getReview(
        int $id,
        ?string $x_schema = null,
        string $contentType = self::contentTypes['getReview'][0]
    ): \Repull\Model\Review|\Repull\Model\Error
    {
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array of \Repull\Model\Review|\Repull\Model\Error|\Repull\Model\Error|\Repull\Model\Error|\Repull\Model\Error|\Repull\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\Repull\Model\Review';
        $request = $this->getReviewRequest($id, $x_schema, $contentType);
    ...
    ): Request
    {
        ...
        if ($offset !== null && $offset > 10000) {
            throw new InvalidArgumentException('invalid value for "$offset" when calling ReviewsApi.listReviews, must be smaller than or equal to 10000.');
        }
        if ($offset !== null && $offset < 0) {
            throw new InvalidArgumentException('invalid value for "$offset" when calling ReviewsApi.listReviews, must be bigger than or equal to 0.');
        }
     ...
     *
     * @param  int $id Internal Repull review id. (required)
     * @param  \Repull\Model\ReplyToReviewRequest $reply_to_review_request reply_to_review_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['replyToReview'] to see the possible values for this operation
     *
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
    ...
    /**
     * Operation replyToReviewWithHttpInfo
     *
     * Reply to a review on any channel
     *
     * @param  int $id Internal Repull review id. (required)
     * @param  \Repull\Model\ReplyToReviewRequest $reply_to_review_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['replyToReview'] to see the possible values for this operation
     *
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array of \Repull\Model\ReplyToReview201Response|\Repull\Model\Error|\Repull\Model\Error|\Repull\Model\Error|\Repull\Model\Error|\Repull\Model\Error|\Repull\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $request = $this->replyToReviewRequest($id, $reply_to_review_request, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    return $this->handleResponseWithDataType(
                        '\Repull\Model\ReplyToReview201Response',
                        $request,
                        $response,
                    );
                case 401:
     ...
     * @return PromiseInterface
     */
    public function replyToReviewAsync(
        int $id,
        \Repull\Model\ReplyToReviewRequest $reply_to_review_request,
        string $contentType = self::contentTypes['replyToReview'][0]
    ): PromiseInterface
    {
        return $this->replyToReviewAsyncWithHttpInfo($id, $reply_to_review_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation replyToReviewAsyncWithHttpInfo
     *
     * Reply to a review on any channel
     *
     * @param  int $id Internal Repull review id. (required)
     ...
     * @return PromiseInterface
     */
    public function replyToReviewAsyncWithHttpInfo(
        int $id,
        \Repull\Model\ReplyToReviewRequest $reply_to_review_request,
        string $contentType = self::contentTypes['replyToReview'][0]
    ): PromiseInterface
    {
        $returnType = '\Repull\Model\ReplyToReview201Response';
        $request = $this->replyToReviewRequest($id, $reply_to_review_request, $contentType);
    ...
    /**
     * Create request for operation 'replyToReview'
     *
     * @param  int $id Internal Repull review id. (required)
     * @param  \Repull\Model\ReplyToReviewRequest $reply_to_review_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['replyToReview'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function replyToReviewRequest(
        int $id,
        \Repull\Model\ReplyToReviewRequest $reply_to_review_request,
        string $contentType = self::contentTypes['replyToReview'][0]
    ): Request
    {
        ...
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $id when calling replyToReview'
            );
        }

        // verify the required parameter 'reply_to_review_request' is set
        if ($reply_to_review_request === null || (is_array($reply_to_review_request) && count($reply_to_review_request) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $reply_to_review_request when calling replyToReview'
            );
        }


        $resourcePath = '/v1/reviews/{id}/reply';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($reply_to_review_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($reply_to_review_request));
            } else {
                $httpBody = $reply_to_review_request;
            }
