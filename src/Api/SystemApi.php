...
class SystemApi
{
     ...
     * @return \Repull\Model\V1HealthGet200Response
     */
    public function v1HealthGet(
        string $contentType = self::contentTypes['v1HealthGet'][0]
    ): \Repull\Model\V1HealthGet200Response
    {
        list($response) = $this->v1HealthGetWithHttpInfo($contentType);
        return $response;
    }
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array of \Repull\Model\V1HealthGet200Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function v1HealthGetWithHttpInfo(
        string $contentType = self::contentTypes['v1HealthGet'][0]
    ): array
    {
     ...
     */
    public function v1HealthGetAsync(
        string $contentType = self::contentTypes['v1HealthGet'][0]
    ): PromiseInterface
    {
     ...
     * @return PromiseInterface
     */
    public function v1HealthGetAsyncWithHttpInfo(
        string $contentType = self::contentTypes['v1HealthGet'][0]
    ): PromiseInterface
    {
        $returnType = '\Repull\Model\V1HealthGet200Response';
        $request = $this->v1HealthGetRequest($contentType);
     ...
     */
    public function v1HealthGetRequest(
        string $contentType = self::contentTypes['v1HealthGet'][0]
    ): Request
    {
